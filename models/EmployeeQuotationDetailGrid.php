 ...
 * Page class
 */
class EmployeeQuotationDetailGrid extends EmployeeQuotationDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeQuotationDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "femployee_quotation_detailgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->detail_id->CurrentValue;
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->quotation_id->OldValue = $this->quotation_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->detail_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['quotation_id'] = $this->quotation_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "employee_quotation") {
            $this->quotation_id->CurrentValue = $this->quotation_id->getSessionValue();
        }

        // Check referential integrity for master table 'employee_quotation_detail'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_employee_quotation();
        if ($this->quotation_id->getSessionValue() != "") {
        $masterFilter = str_replace("@quotation_id@", AdjustSql($this->quotation_id->getSessionValue(), "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
        ...
        // quotation_id
        if ($this->quotation_id->getSessionValue() != "") {
            $rsnew['quotation_id'] = $this->quotation_id->getSessionValue();
        }
