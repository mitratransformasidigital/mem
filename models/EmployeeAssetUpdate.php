 ...
 * Page class
 */
class EmployeeAssetUpdate extends EmployeeAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeAssetUpdate";
    ...
    public function run()
    {
        ...
        if (count($this->RecKeys) <= 0) {
            $this->terminate("employeeassetlist"); // No records selected, return to list
            return;
        }
        if ($this->isUpdate()) {
