...
/**
 * Table class for master_work_date
 */
class MasterWorkDate extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'master_work_date';
        $this->TableName = 'master_work_date';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`master_work_date`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // work_date
        $this->work_date = new DbField('master_work_date', 'master_work_date', 'x_work_date', 'work_date', '`work_date`', CastDateFieldForLike("`work_date`", 0, "DB"), 133, 10, 0, false, '`work_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`master_work_date`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("masterworkdatelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "masterworkdateedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "masterworkdateadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasterWorkDateView";
            case Config("API_ADD_ACTION"):
                return "MasterWorkDateAdd";
            case Config("API_EDIT_ACTION"):
                return "MasterWorkDateEdit";
            case Config("API_DELETE_ACTION"):
                return "MasterWorkDateDelete";
            case Config("API_LIST_ACTION"):
                return "MasterWorkDateList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("masterworkdateview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("masterworkdateview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "masterworkdateadd?" . $this->getUrlParm($parm);
        } else {
            $url = "masterworkdateadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterworkdateedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("masterworkdateadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("masterworkdatedelete", $this->getUrlParm());
    }
