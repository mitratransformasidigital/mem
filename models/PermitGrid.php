 ...
 * Page class
 */
class PermitGrid extends Permit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermitGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpermitgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->permit_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_permit_type")) {
            $this->permit_type->setOldValue($CurrentForm->getValue("o_permit_type"));
        }
        ...
        if (!$this->permit_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
