 ...
 * Page class
 */
class MasterStatusUpdate extends MasterStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterStatusUpdate";
    ...
    public function run()
    {
        ...
        if (count($this->RecKeys) <= 0) {
            $this->terminate("masterstatuslist"); // No records selected, return to list
            return;
        }
        if ($this->isUpdate()) {
    ...
    protected function setupKeyValues($key)
    {
        ...
        $this->status_id->OldValue = $keyFld;
        return true;
    }
