 ...
 * Page class
 */
class MasterPositionAddopt extends MasterPosition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterPositionAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->position->IsDetailKey) {
            $this->position->setFormValue(ConvertFromUtf8($val));
        }
    ...
    {
        global $CurrentForm;
        $this->position->CurrentValue = ConvertToUtf8($this->position->FormValue);
