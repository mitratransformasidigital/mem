 ...
 * Page class
 */
class EmployeeContractSearch extends EmployeeContract
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeContractSearch";
    ...
    public function run()
    {
        ...
        $this->contract_document->Visible = false;
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "employeecontractlist" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->bonus); // bonus
        $this->buildSearchUrl($srchUrl, $this->thr, true); // thr
        $this->buildSearchUrl($srchUrl, $this->contract_start); // contract_start
        $this->buildSearchUrl($srchUrl, $this->contract_end); // contract_end
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->salary->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->bonus->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->thr->AdvancedSearch->post()) {
            $hasValue = true;
        }
        ...
        if ($this->contract_start->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->contract_end->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->salary->EditValue = HtmlEncode($this->salary->AdvancedSearch->SearchValue);
            $this->salary->PlaceHolder = RemoveHtml($this->salary->caption());
            $this->salary->EditAttrs["class"] = "form-control";
            $this->salary->EditCustomAttributes = "";
            $this->salary->EditValue2 = HtmlEncode($this->salary->AdvancedSearch->SearchValue2);
            $this->salary->PlaceHolder = RemoveHtml($this->salary->caption());

            // bonus
            $this->bonus->EditAttrs["class"] = "form-control";
            $this->bonus->EditCustomAttributes = "";
            $this->bonus->EditValue = HtmlEncode($this->bonus->AdvancedSearch->SearchValue);
            $this->bonus->PlaceHolder = RemoveHtml($this->bonus->caption());
            $this->bonus->EditAttrs["class"] = "form-control";
            $this->bonus->EditCustomAttributes = "";
            $this->bonus->EditValue2 = HtmlEncode($this->bonus->AdvancedSearch->SearchValue2);
            $this->bonus->PlaceHolder = RemoveHtml($this->bonus->caption());
            ...
            $this->contract_start->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->contract_start->AdvancedSearch->SearchValue, 0), 8));
            $this->contract_start->PlaceHolder = RemoveHtml($this->contract_start->caption());
            $this->contract_start->EditAttrs["class"] = "form-control";
            $this->contract_start->EditCustomAttributes = "";
            $this->contract_start->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->contract_start->AdvancedSearch->SearchValue2, 0), 8));
            $this->contract_start->PlaceHolder = RemoveHtml($this->contract_start->caption());

            // contract_end
            $this->contract_end->EditAttrs["class"] = "form-control";
            $this->contract_end->EditCustomAttributes = "";
            $this->contract_end->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->contract_end->AdvancedSearch->SearchValue, 0), 8));
            $this->contract_end->PlaceHolder = RemoveHtml($this->contract_end->caption());
            $this->contract_end->EditAttrs["class"] = "form-control";
            $this->contract_end->EditCustomAttributes = "";
            $this->contract_end->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->contract_end->AdvancedSearch->SearchValue2, 0), 8));
            $this->contract_end->PlaceHolder = RemoveHtml($this->contract_end->caption());
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckNumber($this->salary->AdvancedSearch->SearchValue)) {
            $this->salary->addErrorMessage($this->salary->getErrorMessage(false));
        }
        if (!CheckNumber($this->salary->AdvancedSearch->SearchValue2)) {
            $this->salary->addErrorMessage($this->salary->getErrorMessage(false));
        }
        if (!CheckNumber($this->bonus->AdvancedSearch->SearchValue)) {
            $this->bonus->addErrorMessage($this->bonus->getErrorMessage(false));
        }
        if (!CheckNumber($this->bonus->AdvancedSearch->SearchValue2)) {
            $this->bonus->addErrorMessage($this->bonus->getErrorMessage(false));
        }
        if (!CheckDate($this->contract_start->AdvancedSearch->SearchValue)) {
            $this->contract_start->addErrorMessage($this->contract_start->getErrorMessage(false));
        }
        if (!CheckDate($this->contract_start->AdvancedSearch->SearchValue2)) {
            $this->contract_start->addErrorMessage($this->contract_start->getErrorMessage(false));
        }
        if (!CheckDate($this->contract_end->AdvancedSearch->SearchValue)) {
            $this->contract_end->addErrorMessage($this->contract_end->getErrorMessage(false));
        }
        if (!CheckDate($this->contract_end->AdvancedSearch->SearchValue2)) {
            $this->contract_end->addErrorMessage($this->contract_end->getErrorMessage(false));
        }
