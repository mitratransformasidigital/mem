 ...
 * Page class
 */
class OfferingDetailGrid extends OfferingDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfferingDetailGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "foffering_detailgrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_offering_id") && $CurrentForm->hasValue("o_offering_id") && $this->offering_id->CurrentValue != $this->offering_id->OldValue) {
            return false;
        }
    ...
    {
        $this->offering_id->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_offering_id")) {
            $this->offering_id->setOldValue($CurrentForm->getValue("o_offering_id"));
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "offering") {
            $this->offering_id->CurrentValue = $this->offering_id->getSessionValue();
        }
        $conn = $this->getConnection();
