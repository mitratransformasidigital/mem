 ...
 * Page class
 */
class EmployeeTimesheetView extends EmployeeTimesheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimesheetView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("timesheet_id") ?? Route("timesheet_id")) !== null) {
            $this->RecKey["timesheet_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("timesheet_id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("timesheet_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("timesheet_id") ?? Route("timesheet_id")) !== null) {
                ...
                $this->RecKey["timesheet_id"] = $this->timesheet_id->QueryStringValue;
            } elseif (Post("timesheet_id") !== null) {
                $this->timesheet_id->setFormValue(Post("timesheet_id"));
                $this->RecKey["timesheet_id"] = $this->timesheet_id->FormValue;
                ...
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->timesheet_id->CurrentValue, $this->Recordset->fields['timesheet_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "employeetimesheetlist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "employeetimesheetlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.femployee_timesheetview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.femployee_timesheetview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.femployee_timesheetview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
