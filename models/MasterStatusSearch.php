...
class MasterStatusSearch extends MasterStatus
{
    ...
    // Page object name
    public $PageObjName = "MasterStatusSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "masterstatuslist" . "?" . $srchStr;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->status->EditCustomAttributes = "";
            if (!$this->status->Raw) {
                $this->status->AdvancedSearch->SearchValue2 = HtmlDecode($this->status->AdvancedSearch->SearchValue2);
            }
            $this->status->EditValue2 = HtmlEncode($this->status->AdvancedSearch->SearchValue2);
            $this->status->PlaceHolder = RemoveHtml($this->status->caption());
