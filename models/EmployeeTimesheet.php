...
/**
 * Table class for employee_timesheet
 */
class EmployeeTimesheet extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_timesheet';
        ...
        // timesheet_id
        $this->timesheet_id = new DbField('employee_timesheet', 'employee_timesheet', 'x_timesheet_id', 'timesheet_id', '`timesheet_id`', '`timesheet_id`', 3, 11, -1, false, '`timesheet_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // employee_username
        $this->employee_username = new DbField('employee_timesheet', 'employee_timesheet', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 50, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // year
        $this->year = new DbField('employee_timesheet', 'employee_timesheet', 'x_year', 'year', '`year`', '`year`', 3, 11, -1, false, '`year`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->year->Lookup = new Lookup('year', 'employee_timesheet', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // month
        $this->month = new DbField('employee_timesheet', 'employee_timesheet', 'x_month', 'month', '`month`', '`month`', 3, 11, -1, false, '`month`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->month->Lookup = new Lookup('month', 'employee_timesheet', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->month->OptionCount = 12;
        $this->month->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->month->AdvancedSearch->SearchValueDefault = Date('m', strtotime('-1 months'));;
        $this->month->AdvancedSearch->SearchOperatorDefault = "=";
        $this->month->AdvancedSearch->SearchOperatorDefault2 = "";
        $this->month->AdvancedSearch->SearchConditionDefault = "AND";
        $this->Fields['month'] = &$this->month;

        // days
        $this->days = new DbField('employee_timesheet', 'employee_timesheet', 'x_days', 'days', '`days`', '`days`', 3, 11, -1, false, '`days`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sick
        $this->sick = new DbField('employee_timesheet', 'employee_timesheet', 'x_sick', 'sick', '`sick`', '`sick`', 3, 11, -1, false, '`sick`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // leave
        $this->leave = new DbField('employee_timesheet', 'employee_timesheet', 'x_leave', 'leave', '`leave`', '`leave`', 3, 11, -1, false, '`leave`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // permit
        $this->permit = new DbField('employee_timesheet', 'employee_timesheet', 'x_permit', 'permit', '`permit`', '`permit`', 3, 11, -1, false, '`permit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // absence
        $this->absence = new DbField('employee_timesheet', 'employee_timesheet', 'x_absence', 'absence', '`absence`', '`absence`', 3, 11, -1, false, '`absence`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // timesheet_doc
        $this->timesheet_doc = new DbField('employee_timesheet', 'employee_timesheet', 'x_timesheet_doc', 'timesheet_doc', '`timesheet_doc`', '`timesheet_doc`', 200, 150, -1, true, '`timesheet_doc`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->timesheet_doc->Sortable = true; // Allow sort
        $this->Fields['timesheet_doc'] = &$this->timesheet_doc;

        // employee_notes
        $this->employee_notes = new DbField('employee_timesheet', 'employee_timesheet', 'x_employee_notes', 'employee_notes', '`employee_notes`', '`employee_notes`', 201, 65535, -1, false, '`employee_notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->employee_notes->Sortable = true; // Allow sort
        $this->Fields['employee_notes'] = &$this->employee_notes;

        // company_notes
        $this->company_notes = new DbField('employee_timesheet', 'employee_timesheet', 'x_company_notes', 'company_notes', '`company_notes`', '`company_notes`', 201, 65535, -1, false, '`company_notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->company_notes->Sortable = true; // Allow sort
        $this->Fields['company_notes'] = &$this->company_notes;

        // approved
        $this->approved = new DbField('employee_timesheet', 'employee_timesheet', 'x_approved', 'approved', '`approved`', '`approved`', 200, 50, -1, false, '`approved`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->approved->Lookup = new Lookup('approved', 'employee_timesheet', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("employeetimesheetlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "employeetimesheetedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "employeetimesheetadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EmployeeTimesheetAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeTimesheetEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeTimesheetDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("employeetimesheetview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("employeetimesheetview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "employeetimesheetadd?" . $this->getUrlParm($parm);
        } else {
            $url = "employeetimesheetadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeetimesheetedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeetimesheetadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("employeetimesheetdelete", $this->getUrlParm());
    }
