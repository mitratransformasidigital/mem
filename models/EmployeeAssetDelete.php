 ...
 * Page class
 */
class EmployeeAssetDelete extends EmployeeAsset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeAssetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeeassetlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeeassetlist"); // Return to list
                return;
            }
        }
