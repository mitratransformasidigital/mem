 ...
 * Page class
 */
class EmployeeContractDelete extends EmployeeContract
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeContractDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeecontractlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeecontractlist"); // Return to list
                return;
            }
        }
