 ...
 * Page class
 */
class EmployeeTrainingsDelete extends EmployeeTrainings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTrainingsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeetrainingslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeetrainingslist"); // Return to list
                return;
            }
        }
