...
/**
 * Table class for v_quotation_list
 */
class VQuotationList extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_quotation_list';
        $this->TableName = 'v_quotation_list';
        $this->TableType = 'VIEW';
        ...
        // quotation_id
        $this->quotation_id = new DbField('v_quotation_list', 'v_quotation_list', 'x_quotation_id', 'quotation_id', '`quotation_id`', '`quotation_id`', 3, 11, -1, false, '`quotation_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // quotation_no
        $this->quotation_no = new DbField('v_quotation_list', 'v_quotation_list', 'x_quotation_no', 'quotation_no', '`quotation_no`', '`quotation_no`', 200, 50, -1, false, '`quotation_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // quotation_date
        $this->quotation_date = new DbField('v_quotation_list', 'v_quotation_list', 'x_quotation_date', 'quotation_date', '`quotation_date`', '`quotation_date`', 200, 40, -1, false, '`quotation_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // customer_name
        $this->customer_name = new DbField('v_quotation_list', 'v_quotation_list', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, 100, -1, false, '`customer_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone_number
        $this->phone_number = new DbField('v_quotation_list', 'v_quotation_list', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, 50, -1, false, '`phone_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // contact
        $this->contact = new DbField('v_quotation_list', 'v_quotation_list', 'x_contact', 'contact', '`contact`', '`contact`', 200, 100, -1, false, '`contact`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // city
        $this->city = new DbField('v_quotation_list', 'v_quotation_list', 'x_city', 'city', '`city`', '`city`', 200, 50, -1, false, '`city`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_name
        $this->employee_name = new DbField('v_quotation_list', 'v_quotation_list', 'x_employee_name', 'employee_name', '`employee_name`', '`employee_name`', 200, 150, -1, false, '`employee_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rate
        $this->rate = new DbField('v_quotation_list', 'v_quotation_list', 'x_rate', 'rate', '`rate`', '`rate`', 3, 11, -1, false, '`rate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // qty
        $this->qty = new DbField('v_quotation_list', 'v_quotation_list', 'x_qty', 'qty', '`qty`', '`qty`', 3, 11, -1, false, '`qty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // total
        $this->total = new DbField('v_quotation_list', 'v_quotation_list', 'x_total', 'total', '`total`', '`total`', 20, 21, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // customer_address
        $this->customer_address = new DbField('v_quotation_list', 'v_quotation_list', 'x_customer_address', 'customer_address', '`customer_address`', '`customer_address`', 201, 300, -1, false, '`customer_address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vquotationlistlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vquotationlistview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vquotationlistedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vquotationlistadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VQuotationListView";
            case Config("API_ADD_ACTION"):
                return "VQuotationListAdd";
            case Config("API_EDIT_ACTION"):
                return "VQuotationListEdit";
            case Config("API_DELETE_ACTION"):
                return "VQuotationListDelete";
            case Config("API_LIST_ACTION"):
                return "VQuotationListList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vquotationlistview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vquotationlistview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vquotationlistadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vquotationlistadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vquotationlistedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vquotationlistadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vquotationlistdelete", $this->getUrlParm());
    }
