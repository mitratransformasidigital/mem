...
/**
 * Table class for employee_trainings
 */
class EmployeeTrainings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_trainings';
        $this->TableName = 'employee_trainings';
        ...
        // training_id
        $this->training_id = new DbField('employee_trainings', 'employee_trainings', 'x_training_id', 'training_id', '`training_id`', '`training_id`', 3, 11, -1, false, '`training_id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee_username
        $this->employee_username = new DbField('employee_trainings', 'employee_trainings', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 100, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // training_name
        $this->training_name = new DbField('employee_trainings', 'employee_trainings', 'x_training_name', 'training_name', '`training_name`', '`training_name`', 200, 100, -1, false, '`training_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // training_start
        $this->training_start = new DbField('employee_trainings', 'employee_trainings', 'x_training_start', 'training_start', '`training_start`', CastDateFieldForLike("`training_start`", 0, "DB"), 133, 10, 0, false, '`training_start`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // training_end
        $this->training_end = new DbField('employee_trainings', 'employee_trainings', 'x_training_end', 'training_end', '`training_end`', CastDateFieldForLike("`training_end`", 0, "DB"), 133, 10, 0, false, '`training_end`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // training_company
        $this->training_company = new DbField('employee_trainings', 'employee_trainings', 'x_training_company', 'training_company', '`training_company`', '`training_company`', 200, 100, -1, false, '`training_company`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->training_company->Sortable = true; // Allow sort
        $this->Fields['training_company'] = &$this->training_company;

        // certificate_start
        $this->certificate_start = new DbField('employee_trainings', 'employee_trainings', 'x_certificate_start', 'certificate_start', '`certificate_start`', CastDateFieldForLike("`certificate_start`", 0, "DB"), 133, 10, 0, false, '`certificate_start`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // certificate_end
        $this->certificate_end = new DbField('employee_trainings', 'employee_trainings', 'x_certificate_end', 'certificate_end', '`certificate_end`', CastDateFieldForLike("`certificate_end`", 0, "DB"), 133, 10, 0, false, '`certificate_end`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // notes
        $this->notes = new DbField('employee_trainings', 'employee_trainings', 'x_notes', 'notes', '`notes`', '`notes`', 200, 255, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->notes->Sortable = true; // Allow sort
        $this->Fields['notes'] = &$this->notes;

        // training_document
        $this->training_document = new DbField('employee_trainings', 'employee_trainings', 'x_training_document', 'training_document', '`training_document`', '`training_document`', 200, 255, -1, true, '`training_document`', false, false, false, 'FORMATTED TEXT', 'FILE');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_trainings`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("employeetrainingslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "employeetrainingsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "employeetrainingsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeTrainingsView";
            case Config("API_ADD_ACTION"):
                return "EmployeeTrainingsAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeTrainingsEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeTrainingsDelete";
            case Config("API_LIST_ACTION"):
                return "EmployeeTrainingsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("employeetrainingsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("employeetrainingsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "employeetrainingsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "employeetrainingsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeetrainingsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeetrainingsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("employeetrainingsdelete", $this->getUrlParm());
    }
