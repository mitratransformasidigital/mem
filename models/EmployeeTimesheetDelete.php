 ...
 * Page class
 */
class EmployeeTimesheetDelete extends EmployeeTimesheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimesheetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeetimesheetlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeetimesheetlist"); // Return to list
                return;
            }
        }
