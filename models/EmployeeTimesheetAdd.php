 ...
 * Page class
 */
class EmployeeTimesheetAdd extends EmployeeTimesheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimesheetAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("employeetimesheetlist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "employeetimesheetview") {
