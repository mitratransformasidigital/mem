 ...
 * Page class
 */
class EmployeeShiftGrid extends EmployeeShift
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeShiftGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "femployee_shiftgrid";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->es_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
