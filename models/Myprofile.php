...
/**
 * Table class for myprofile
 */
class Myprofile extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'myprofile';
        $this->TableName = 'myprofile';
        $this->TableType = 'VIEW';
        ...
        // employee_name
        $this->employee_name = new DbField('myprofile', 'myprofile', 'x_employee_name', 'employee_name', '`employee_name`', '`employee_name`', 200, 150, -1, false, '`employee_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_username
        $this->employee_username = new DbField('myprofile', 'myprofile', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 50, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_password
        $this->employee_password = new DbField('myprofile', 'myprofile', 'x_employee_password', 'employee_password', '`employee_password`', '`employee_password`', 200, 50, -1, false, '`employee_password`', false, false, false, 'FORMATTED TEXT', 'PASSWORD');
        ...
        // employee_email
        $this->employee_email = new DbField('myprofile', 'myprofile', 'x_employee_email', 'employee_email', '`employee_email`', '`employee_email`', 200, 50, -1, false, '`employee_email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // birth_date
        $this->birth_date = new DbField('myprofile', 'myprofile', 'x_birth_date', 'birth_date', '`birth_date`', CastDateFieldForLike("`birth_date`", 5, "DB"), 135, 19, 5, false, '`birth_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nik
        $this->nik = new DbField('myprofile', 'myprofile', 'x_nik', 'nik', '`nik`', '`nik`', 200, 150, -1, false, '`nik`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // npwp
        $this->npwp = new DbField('myprofile', 'myprofile', 'x_npwp', 'npwp', '`npwp`', '`npwp`', 200, 50, -1, false, '`npwp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->npwp->Sortable = true; // Allow sort
        $this->Fields['npwp'] = &$this->npwp;

        // address
        $this->address = new DbField('myprofile', 'myprofile', 'x_address', 'address', '`address`', '`address`', 200, 150, -1, false, '`address`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->address->Sortable = true; // Allow sort
        $this->Fields['address'] = &$this->address;

        // city_id
        $this->city_id = new DbField('myprofile', 'myprofile', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 200, 10, -1, false, '`city_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // postal_code
        $this->postal_code = new DbField('myprofile', 'myprofile', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 50, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->postal_code->Sortable = true; // Allow sort
        $this->Fields['postal_code'] = &$this->postal_code;

        // bank_number
        $this->bank_number = new DbField('myprofile', 'myprofile', 'x_bank_number', 'bank_number', '`bank_number`', '`bank_number`', 200, 50, -1, false, '`bank_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bank_name
        $this->bank_name = new DbField('myprofile', 'myprofile', 'x_bank_name', 'bank_name', '`bank_name`', '`bank_name`', 200, 50, -1, false, '`bank_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // scan_ktp
        $this->scan_ktp = new DbField('myprofile', 'myprofile', 'x_scan_ktp', 'scan_ktp', '`scan_ktp`', '`scan_ktp`', 200, 200, -1, true, '`scan_ktp`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->scan_ktp->Sortable = true; // Allow sort
        $this->Fields['scan_ktp'] = &$this->scan_ktp;

        // scan_npwp
        $this->scan_npwp = new DbField('myprofile', 'myprofile', 'x_scan_npwp', 'scan_npwp', '`scan_npwp`', '`scan_npwp`', 200, 250, -1, true, '`scan_npwp`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->scan_npwp->Sortable = true; // Allow sort
        $this->Fields['scan_npwp'] = &$this->scan_npwp;

        // curiculum_vitae
        $this->curiculum_vitae = new DbField('myprofile', 'myprofile', 'x_curiculum_vitae', 'curiculum_vitae', '`curiculum_vitae`', '`curiculum_vitae`', 200, 250, -1, true, '`curiculum_vitae`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->curiculum_vitae->Sortable = true; // Allow sort
        $this->Fields['curiculum_vitae'] = &$this->curiculum_vitae;

        // technical_skill
        $this->technical_skill = new DbField('myprofile', 'myprofile', 'x_technical_skill', 'technical_skill', '`technical_skill`', '`technical_skill`', 200, 250, -1, false, '`technical_skill`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->technical_skill->Sortable = true; // Allow sort
        $this->Fields['technical_skill'] = &$this->technical_skill;

        // about_me
        $this->about_me = new DbField('myprofile', 'myprofile', 'x_about_me', 'about_me', '`about_me`', '`about_me`', 200, 250, -1, false, '`about_me`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->about_me->Sortable = true; // Allow sort
        $this->Fields['about_me'] = &$this->about_me;

        // position_id
        $this->position_id = new DbField('myprofile', 'myprofile', 'x_position_id', 'position_id', '`position_id`', '`position_id`', 3, 50, -1, false, '`position_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // religion
        $this->religion = new DbField('myprofile', 'myprofile', 'x_religion', 'religion', '`religion`', '`religion`', 200, 50, -1, false, '`religion`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->religion->Lookup = new Lookup('religion', 'myprofile', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->religion->OptionCount = 5;
        $this->Fields['religion'] = &$this->religion;

        // status_id
        $this->status_id = new DbField('myprofile', 'myprofile', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 3, 50, -1, false, '`status_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // skill_id
        $this->skill_id = new DbField('myprofile', 'myprofile', 'x_skill_id', 'skill_id', '`skill_id`', '`skill_id`', 3, 50, -1, false, '`skill_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // office_id
        $this->office_id = new DbField('myprofile', 'myprofile', 'x_office_id', 'office_id', '`office_id`', '`office_id`', 3, 50, -1, false, '`office_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // hire_date
        $this->hire_date = new DbField('myprofile', 'myprofile', 'x_hire_date', 'hire_date', '`hire_date`', CastDateFieldForLike("`hire_date`", 5, "DB"), 133, 10, 5, false, '`hire_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // termination_date
        $this->termination_date = new DbField('myprofile', 'myprofile', 'x_termination_date', 'termination_date', '`termination_date`', CastDateFieldForLike("`termination_date`", 5, "DB"), 133, 10, 5, false, '`termination_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user_level
        $this->user_level = new DbField('myprofile', 'myprofile', 'x_user_level', 'user_level', '`user_level`', '`user_level`', 3, 11, -1, false, '`user_level`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        $this->user_level->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`myprofile`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("myprofilelist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "myprofileedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "myprofileadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("myprofileview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("myprofileview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "myprofileadd?" . $this->getUrlParm($parm);
        } else {
            $url = "myprofileadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("myprofileedit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("myprofileedit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("myprofileadd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("myprofileadd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("myprofiledelete", $this->getUrlParm());
    }
