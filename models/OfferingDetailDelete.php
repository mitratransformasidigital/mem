 ...
 * Page class
 */
class OfferingDetailDelete extends OfferingDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfferingDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("offeringdetaillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("offeringdetaillist"); // Return to list
                return;
            }
        }
