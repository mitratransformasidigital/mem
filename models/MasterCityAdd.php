 ...
 * Page class
 */
class MasterCityAdd extends MasterCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterCityAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("mastercitylist"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "mastercityview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->city->CurrentValue != "") { // Check field with unique index
            $filter = "(`city` = '" . AdjustSql($this->city->CurrentValue, $this->Dbid) . "')";
        ...
        if (strval($this->province_id->CurrentValue) != "") {
            $masterFilter = str_replace("@province_id@", AdjustSql($this->province_id->CurrentValue, "DB"), $masterFilter);
        } else {
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['city_id']) == "") {
