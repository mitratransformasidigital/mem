 ...
 * Page class
 */
class EmployeeQuotationDetailPreview extends EmployeeQuotationDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeQuotationDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "employee_quotation") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=employee_quotation&" . GetForeignKeyUrl("fk_quotation_id", $this->quotation_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "employee_quotation") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->quotation_id->setQueryStringValue($val);
            }
        }
    }
