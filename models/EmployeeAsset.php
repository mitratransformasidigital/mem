...
/**
 * Table class for employee_asset
 */
class EmployeeAsset extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_asset';
        $this->TableName = 'employee_asset';
        ...
        // asset_id
        $this->asset_id = new DbField('employee_asset', 'employee_asset', 'x_asset_id', 'asset_id', '`asset_id`', '`asset_id`', 3, 11, -1, false, '`asset_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // employee_username
        $this->employee_username = new DbField('employee_asset', 'employee_asset', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 50, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // asset_name
        $this->asset_name = new DbField('employee_asset', 'employee_asset', 'x_asset_name', 'asset_name', '`asset_name`', '`asset_name`', 200, 100, -1, false, '`asset_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // year
        $this->year = new DbField('employee_asset', 'employee_asset', 'x_year', 'year', '`year`', '`year`', 3, 11, -1, false, '`year`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // serial_number
        $this->serial_number = new DbField('employee_asset', 'employee_asset', 'x_serial_number', 'serial_number', '`serial_number`', '`serial_number`', 200, 100, -1, false, '`serial_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // value
        $this->value = new DbField('employee_asset', 'employee_asset', 'x_value', 'value', '`value`', '`value`', 131, 18, -1, false, '`value`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // asset_received
        $this->asset_received = new DbField('employee_asset', 'employee_asset', 'x_asset_received', 'asset_received', '`asset_received`', CastDateFieldForLike("`asset_received`", 5, "DB"), 133, 10, 5, false, '`asset_received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // asset_return
        $this->asset_return = new DbField('employee_asset', 'employee_asset', 'x_asset_return', 'asset_return', '`asset_return`', CastDateFieldForLike("`asset_return`", 5, "DB"), 133, 10, 5, false, '`asset_return`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // asset_picture
        $this->asset_picture = new DbField('employee_asset', 'employee_asset', 'x_asset_picture', 'asset_picture', '`asset_picture`', '`asset_picture`', 200, 150, -1, true, '`asset_picture`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->asset_picture->Sortable = true; // Allow sort
        $this->Fields['asset_picture'] = &$this->asset_picture;

        // notes
        $this->notes = new DbField('employee_asset', 'employee_asset', 'x_notes', 'notes', '`notes`', '`notes`', 201, 65535, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_asset`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("employeeassetlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "employeeassetedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "employeeassetadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeAssetView";
            case Config("API_ADD_ACTION"):
                return "EmployeeAssetAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeAssetEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeAssetDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("employeeassetview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("employeeassetview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "employeeassetadd?" . $this->getUrlParm($parm);
        } else {
            $url = "employeeassetadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeeassetedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeeassetadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("employeeassetdelete", $this->getUrlParm());
    }
