 ...
 * Page class
 */
class OfferingDetailPreview extends OfferingDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfferingDetailPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "offering") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=offering&" . GetForeignKeyUrl("fk_offering_id", $this->offering_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "offering") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->offering_id->setQueryStringValue($val);
            }
        }
    }
