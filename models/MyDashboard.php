 ...
 * Page class
 */
class MyDashboard extends ReportTable
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'My Dashboard';

    // Page object name
    public $PageObjName = "MyDashboard";
    ...
    public function __construct()
    {
        ...
        // Initialize
        $this->TableVar = 'My_Dashboard';
        $this->TableName = 'My Dashboard';
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'My Dashboard');
        }
