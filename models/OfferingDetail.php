...
/**
 * Table class for offering_detail
 */
class OfferingDetail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'offering_detail';
        $this->TableName = 'offering_detail';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`offering_detail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // detail_id
        $this->detail_id = new DbField('offering_detail', 'offering_detail', 'x_detail_id', 'detail_id', '`detail_id`', '`detail_id`', 3, 11, -1, false, '`detail_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // offering_id
        $this->offering_id = new DbField('offering_detail', 'offering_detail', 'x_offering_id', 'offering_id', '`offering_id`', '`offering_id`', 3, 11, -1, false, '`offering_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->offering_id->IsForeignKey = true; // Foreign key field
        $this->offering_id->Nullable = false; // NOT NULL field
        $this->offering_id->Required = true; // Required field
        $this->offering_id->Sortable = true; // Allow sort
        $this->offering_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['offering_id'] = &$this->offering_id;

        // description
        $this->description = new DbField('offering_detail', 'offering_detail', 'x_description', 'description', '`description`', '`description`', 201, 500, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // qty
        $this->qty = new DbField('offering_detail', 'offering_detail', 'x_qty', 'qty', '`qty`', '`qty`', 3, 11, -1, false, '`qty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rate
        $this->rate = new DbField('offering_detail', 'offering_detail', 'x_rate', 'rate', '`rate`', '`rate`', 3, 11, -1, false, '`rate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // discount
        $this->discount = new DbField('offering_detail', 'offering_detail', 'x_discount', 'discount', '`discount`', '`discount`', 3, 11, -1, false, '`discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->discount->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['discount'] = &$this->discount;

        // total
        $this->total = new DbField('offering_detail', 'offering_detail', 'x_total', 'total', 'qty*rate * (100-discount)/100', 'qty*rate * (100-discount)/100', 131, 35, -1, false, 'qty*rate * (100-discount)/100', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "offering") {
            if ($this->offering_id->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`offering_id`", $this->offering_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "offering") {
            if ($this->offering_id->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`offering_id`", $this->offering_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_offering()
    {
        return "`offering_id`=@offering_id@";
    }
    // Detail filter
    public function sqlDetailFilter_offering()
    {
        return "`offering_id`=@offering_id@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`offering_detail`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, qty*rate * (100-discount)/100 AS `total`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("offeringdetaillist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "offeringdetailedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "offeringdetailadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "OfferingDetailView";
            case Config("API_ADD_ACTION"):
                return "OfferingDetailAdd";
            case Config("API_EDIT_ACTION"):
                return "OfferingDetailEdit";
            case Config("API_DELETE_ACTION"):
                return "OfferingDetailDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("offeringdetailview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("offeringdetailview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "offeringdetailadd?" . $this->getUrlParm($parm);
        } else {
            $url = "offeringdetailadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("offeringdetailedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("offeringdetailadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("offeringdetaildelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "offering" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_offering_id", $this->offering_id->CurrentValue);
        }
        return $url;
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if ($this->offering_id->getSessionValue() != "") {
            ...
            $this->offering_id->EditValue = $this->offering_id->CurrentValue;
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->offering_id);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->offering_id);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->offering_id, '');
