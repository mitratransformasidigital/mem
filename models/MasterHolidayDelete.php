 ...
 * Page class
 */
class MasterHolidayDelete extends MasterHoliday
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterHolidayDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterholidaylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterholidaylist"); // Return to list
                return;
            }
        }
