 ...
 * Page class
 */
class VTimesheetListSearch extends VTimesheetList
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VTimesheetListSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "vtimesheetlistlist" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->work_date); // work_date
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->work_date->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("vtimesheetlistlist"), "", $this->TableVar, true);
        $pageId = "search";
