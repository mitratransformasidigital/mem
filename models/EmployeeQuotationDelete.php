 ...
 * Page class
 */
class EmployeeQuotationDelete extends EmployeeQuotation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeQuotationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeequotationlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeequotationlist"); // Return to list
                return;
            }
        }
