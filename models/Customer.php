...
class Customer extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // customer_id
        $this->customer_id = new DbField('customer', 'customer', 'x_customer_id', 'customer_id', '`customer_id`', '`customer_id`', 3, 11, -1, false, '`customer_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // customer_name
        $this->customer_name = new DbField('customer', 'customer', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, 100, -1, false, '`customer_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // address
        $this->address = new DbField('customer', 'customer', 'x_address', 'address', '`address`', '`address`', 201, 300, -1, false, '`address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // city_id
        $this->city_id = new DbField('customer', 'customer', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 3, 11, -1, false, '`city_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // phone_number
        $this->phone_number = new DbField('customer', 'customer', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, 50, -1, false, '`phone_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // contact
        $this->contact = new DbField('customer', 'customer', 'x_contact', 'contact', '`contact`', '`contact`', 200, 100, -1, false, '`contact`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "master_city") {
            if ($this->city_id->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`city_id`", $this->city_id->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->customer_id->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->customer_id->CurrentValue);
        } else {
