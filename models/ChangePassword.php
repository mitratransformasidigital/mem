 ...
 * Page class
 */
class ChangePassword extends Employee
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("employee", "employee", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("employee", "employee", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("employee", "employee", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
