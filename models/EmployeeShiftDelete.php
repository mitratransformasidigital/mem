 ...
 * Page class
 */
class EmployeeShiftDelete extends EmployeeShift
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeShiftDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeeshiftlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeeshiftlist"); // Return to list
                return;
            }
        }
