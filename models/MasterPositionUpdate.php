 ...
 * Page class
 */
class MasterPositionUpdate extends MasterPosition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterPositionUpdate";
    ...
    public function run()
    {
        ...
        if (count($this->RecKeys) <= 0) {
            $this->terminate("masterpositionlist"); // No records selected, return to list
            return;
        }
        if ($this->isUpdate()) {
        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while (!$rs->EOF) {
                if ($i == 1) {
                    ...
                    if (!CompareValue($this->position->DbValue, $rs->fields['position'])) {
    ...
    protected function setupKeyValues($key)
    {
        ...
        $this->position_id->OldValue = $keyFld;
        return true;
    }
