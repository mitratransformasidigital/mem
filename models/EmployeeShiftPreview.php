 ...
 * Page class
 */
class EmployeeShiftPreview extends EmployeeShift
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeShiftPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "master_shift") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_shift&" . GetForeignKeyUrl("fk_shift_id", $this->shift_id->QueryStringValue) . "";
        }
        ...
        if ($masterTblVar == "master_shift") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->shift_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "employee") {
