 ...
 * Page class
 */
class MasterCityGrid extends MasterCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterCityGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fmaster_citygrid";
