 ...
 * Page class
 */
class OfferingDetailEdit extends OfferingDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfferingDetailEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // offering_id
            if ($this->offering_id->getSessionValue() != "") {
                $this->offering_id->ReadOnly = true;
            }
            $this->offering_id->setDbValueDef($rsnew, $this->offering_id->CurrentValue, 0, $this->offering_id->ReadOnly);
