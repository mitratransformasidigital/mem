 ...
 * Page class
 */
class EmployeeQuotationDetailDelete extends EmployeeQuotationDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeQuotationDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("employeequotationdetaillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("employeequotationdetaillist"); // Return to list
                return;
            }
        }
