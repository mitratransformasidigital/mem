 ...
 * Page class
 */
class MasterShiftAddopt extends MasterShift
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterShiftAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->shift_name->IsDetailKey) {
            $this->shift_name->setFormValue(ConvertFromUtf8($val));
        }
        ...
        if (!$this->sunday_time_in->IsDetailKey) {
            $this->sunday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->sunday_time_out->IsDetailKey) {
            $this->sunday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->monday_time_in->IsDetailKey) {
            $this->monday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->monday_time_out->IsDetailKey) {
            $this->monday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->tuesday_time_in->IsDetailKey) {
            $this->tuesday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->tuesday_time_out->IsDetailKey) {
            $this->tuesday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->wednesday_time_in->IsDetailKey) {
            $this->wednesday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->wednesday_time_out->IsDetailKey) {
            $this->wednesday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->thursday_time_in->IsDetailKey) {
            $this->thursday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->thursday_time_out->IsDetailKey) {
            $this->thursday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->friday_time_in->IsDetailKey) {
            $this->friday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->friday_time_out->IsDetailKey) {
            $this->friday_time_out->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->saturday_time_in->IsDetailKey) {
            $this->saturday_time_in->setFormValue(ConvertFromUtf8($val));
        ...
        if (!$this->saturday_time_out->IsDetailKey) {
            $this->saturday_time_out->setFormValue(ConvertFromUtf8($val));
    ...
    {
        global $CurrentForm;
        $this->shift_name->CurrentValue = ConvertToUtf8($this->shift_name->FormValue);
        $this->sunday_time_in->CurrentValue = ConvertToUtf8($this->sunday_time_in->FormValue);
        $this->sunday_time_in->CurrentValue = UnFormatDateTime($this->sunday_time_in->CurrentValue, 4);
        $this->sunday_time_out->CurrentValue = ConvertToUtf8($this->sunday_time_out->FormValue);
        $this->sunday_time_out->CurrentValue = UnFormatDateTime($this->sunday_time_out->CurrentValue, 4);
        $this->monday_time_in->CurrentValue = ConvertToUtf8($this->monday_time_in->FormValue);
        $this->monday_time_in->CurrentValue = UnFormatDateTime($this->monday_time_in->CurrentValue, 4);
        $this->monday_time_out->CurrentValue = ConvertToUtf8($this->monday_time_out->FormValue);
        $this->monday_time_out->CurrentValue = UnFormatDateTime($this->monday_time_out->CurrentValue, 4);
        $this->tuesday_time_in->CurrentValue = ConvertToUtf8($this->tuesday_time_in->FormValue);
        $this->tuesday_time_in->CurrentValue = UnFormatDateTime($this->tuesday_time_in->CurrentValue, 4);
        $this->tuesday_time_out->CurrentValue = ConvertToUtf8($this->tuesday_time_out->FormValue);
        $this->tuesday_time_out->CurrentValue = UnFormatDateTime($this->tuesday_time_out->CurrentValue, 4);
        $this->wednesday_time_in->CurrentValue = ConvertToUtf8($this->wednesday_time_in->FormValue);
        $this->wednesday_time_in->CurrentValue = UnFormatDateTime($this->wednesday_time_in->CurrentValue, 4);
        $this->wednesday_time_out->CurrentValue = ConvertToUtf8($this->wednesday_time_out->FormValue);
        $this->wednesday_time_out->CurrentValue = UnFormatDateTime($this->wednesday_time_out->CurrentValue, 4);
        $this->thursday_time_in->CurrentValue = ConvertToUtf8($this->thursday_time_in->FormValue);
        $this->thursday_time_in->CurrentValue = UnFormatDateTime($this->thursday_time_in->CurrentValue, 4);
        $this->thursday_time_out->CurrentValue = ConvertToUtf8($this->thursday_time_out->FormValue);
        $this->thursday_time_out->CurrentValue = UnFormatDateTime($this->thursday_time_out->CurrentValue, 4);
        $this->friday_time_in->CurrentValue = ConvertToUtf8($this->friday_time_in->FormValue);
        $this->friday_time_in->CurrentValue = UnFormatDateTime($this->friday_time_in->CurrentValue, 4);
        $this->friday_time_out->CurrentValue = ConvertToUtf8($this->friday_time_out->FormValue);
        $this->friday_time_out->CurrentValue = UnFormatDateTime($this->friday_time_out->CurrentValue, 4);
        $this->saturday_time_in->CurrentValue = ConvertToUtf8($this->saturday_time_in->FormValue);
        $this->saturday_time_in->CurrentValue = UnFormatDateTime($this->saturday_time_in->CurrentValue, 4);
        $this->saturday_time_out->CurrentValue = ConvertToUtf8($this->saturday_time_out->FormValue);
        $this->saturday_time_out->CurrentValue = UnFormatDateTime($this->saturday_time_out->CurrentValue, 4);
    }
