...
/**
 * Table class for employee_contract
 */
class EmployeeContract extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_contract';
        ...
        // contract_id
        $this->contract_id = new DbField('employee_contract', 'employee_contract', 'x_contract_id', 'contract_id', '`contract_id`', '`contract_id`', 3, 11, -1, false, '`contract_id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee_username
        $this->employee_username = new DbField('employee_contract', 'employee_contract', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 50, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // salary
        $this->salary = new DbField('employee_contract', 'employee_contract', 'x_salary', 'salary', '`salary`', '`salary`', 131, 18, -1, false, '`salary`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bonus
        $this->bonus = new DbField('employee_contract', 'employee_contract', 'x_bonus', 'bonus', '`bonus`', '`bonus`', 131, 18, -1, false, '`bonus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // thr
        $this->thr = new DbField('employee_contract', 'employee_contract', 'x_thr', 'thr', '`thr`', '`thr`', 16, 1, -1, false, '`thr`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // contract_start
        $this->contract_start = new DbField('employee_contract', 'employee_contract', 'x_contract_start', 'contract_start', '`contract_start`', CastDateFieldForLike("`contract_start`", 0, "DB"), 133, 10, 0, false, '`contract_start`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // contract_end
        $this->contract_end = new DbField('employee_contract', 'employee_contract', 'x_contract_end', 'contract_end', '`contract_end`', CastDateFieldForLike("`contract_end`", 0, "DB"), 133, 10, 0, false, '`contract_end`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // office_id
        $this->office_id = new DbField('employee_contract', 'employee_contract', 'x_office_id', 'office_id', '`office_id`', '`office_id`', 3, 50, -1, false, '`office_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // contract_document
        $this->contract_document = new DbField('employee_contract', 'employee_contract', 'x_contract_document', 'contract_document', '`contract_document`', '`contract_document`', 200, 150, -1, true, '`contract_document`', false, false, false, 'FORMATTED TEXT', 'FILE');
        $this->contract_document->Sortable = true; // Allow sort
        $this->Fields['contract_document'] = &$this->contract_document;

        // notes
        $this->notes = new DbField('employee_contract', 'employee_contract', 'x_notes', 'notes', '`notes`', '`notes`', 201, 65535, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_contract`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("employeecontractlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "employeecontractedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "employeecontractadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EmployeeContractAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeContractEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeContractDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("employeecontractview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("employeecontractview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "employeecontractadd?" . $this->getUrlParm($parm);
        } else {
            $url = "employeecontractadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeecontractedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("employeecontractadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("employeecontractdelete", $this->getUrlParm());
    }
