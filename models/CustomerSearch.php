...
class CustomerSearch extends Customer
{
    ...
    protected function loadSearchValues()
    {
        // Load search values
        $hasValue = false;
        if ($this->customer_name->AdvancedSearch->post()) {
            $hasValue = true;
        }
        ...
        if ($this->contact->AdvancedSearch->post()) {
            $hasValue = true;
        }
        return $hasValue;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->customer_name->EditCustomAttributes = "";
            if (!$this->customer_name->Raw) {
                $this->customer_name->AdvancedSearch->SearchValue2 = HtmlDecode($this->customer_name->AdvancedSearch->SearchValue2);
            }
            $this->customer_name->EditValue2 = HtmlEncode($this->customer_name->AdvancedSearch->SearchValue2);
            $this->customer_name->PlaceHolder = RemoveHtml($this->customer_name->caption());
