 ...
 * Page class
 */
class MasterOfficeDelete extends MasterOffice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterOfficeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("masterofficelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("masterofficelist"); // Return to list
                return;
            }
        }
