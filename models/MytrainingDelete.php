 ...
 * Page class
 */
class MytrainingDelete extends Mytraining
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MytrainingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mytraininglist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mytraininglist"); // Return to list
                return;
            }
        }
