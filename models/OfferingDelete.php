 ...
 * Page class
 */
class OfferingDelete extends Offering
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfferingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("offeringlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("offeringlist"); // Return to list
                return;
            }
        }
