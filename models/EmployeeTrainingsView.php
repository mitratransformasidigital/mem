 ...
 * Page class
 */
class EmployeeTrainingsView extends EmployeeTrainings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTrainingsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("training_id") ?? Route("training_id")) !== null) {
            $this->RecKey["training_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("training_id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("training_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("training_id") ?? Route("training_id")) !== null) {
                ...
                $this->RecKey["training_id"] = $this->training_id->QueryStringValue;
            } elseif (Post("training_id") !== null) {
                $this->training_id->setFormValue(Post("training_id"));
                $this->RecKey["training_id"] = $this->training_id->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("employeetrainingslist"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->training_id->CurrentValue, $this->Recordset->fields['training_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "employeetrainingslist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "employeetrainingslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.femployee_trainingsview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.femployee_trainingsview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.femployee_trainingsview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
