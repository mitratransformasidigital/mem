 ...
 * Page class
 */
class MasterOfficeGrid extends MasterOffice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterOfficeGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fmaster_officegrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->office_id->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_office") && $CurrentForm->hasValue("o_office") && $this->office->CurrentValue != $this->office->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_phone_number") && $CurrentForm->hasValue("o_phone_number") && $this->phone_number->CurrentValue != $this->phone_number->OldValue) {
            return false;
        }
    ...
    {
        $this->office->clearErrorMessage();
        $this->address->clearErrorMessage();
        $this->city_id->clearErrorMessage();
        $this->phone_number->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_office")) {
            $this->office->setOldValue($CurrentForm->getValue("o_office"));
        }
        ...
        if ($CurrentForm->hasValue("o_phone_number")) {
            $this->phone_number->setOldValue($CurrentForm->getValue("o_phone_number"));
        }
        ...
        if (!$this->office_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // office
            $this->office->setDbValueDef($rsnew, $this->office->CurrentValue, "", $this->office->ReadOnly);
