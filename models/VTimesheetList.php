...
/**
 * Table class for v_timesheet_list
 */
class VTimesheetList extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_timesheet_list';
        $this->TableName = 'v_timesheet_list';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_timesheet_list`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // employee_username
        $this->employee_username = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_employee_username', 'employee_username', '`employee_username`', '`employee_username`', 200, 50, -1, false, '`employee_username`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // work_date
        $this->work_date = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_work_date', 'work_date', '`work_date`', CastDateFieldForLike("`work_date`", 0, "DB"), 133, 10, 0, false, '`work_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // time_in
        $this->time_in = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_time_in', 'time_in', '`time_in`', CastDateFieldForLike("`time_in`", 4, "DB"), 134, 10, 4, false, '`time_in`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // time_out
        $this->time_out = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_time_out', 'time_out', '`time_out`', CastDateFieldForLike("`time_out`", 4, "DB"), 134, 10, 4, false, '`time_out`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->Fields['description'] = &$this->description;

        // absence
        $this->absence = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_absence', 'absence', '`absence`', '`absence`', 3, 1, -1, false, '`absence`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // days
        $this->days = new DbField('v_timesheet_list', 'v_timesheet_list', 'x_days', 'days', '`days`', '`days`', 3, 1, -1, false, '`days`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_timesheet_list`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vtimesheetlistlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vtimesheetlistview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vtimesheetlistedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vtimesheetlistadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VTimesheetListView";
            case Config("API_ADD_ACTION"):
                return "VTimesheetListAdd";
            case Config("API_EDIT_ACTION"):
                return "VTimesheetListEdit";
            case Config("API_DELETE_ACTION"):
                return "VTimesheetListDelete";
            case Config("API_LIST_ACTION"):
                return "VTimesheetListList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vtimesheetlistview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vtimesheetlistview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vtimesheetlistadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vtimesheetlistadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vtimesheetlistedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vtimesheetlistadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vtimesheetlistdelete", $this->getUrlParm());
    }
