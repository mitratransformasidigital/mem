...
class EmployeeShiftSearch extends EmployeeShift
{
    ...
    // Page object name
    public $PageObjName = "EmployeeShiftSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "employeeshiftlist" . "?" . $srchStr;
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->es_id); // es_id
        $this->buildSearchUrl($srchUrl, $this->shift_id); // shift_id
    ...
    protected function loadSearchValues()
    {
        // Load search values
        $hasValue = false;
        if ($this->es_id->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->es_id->EditValue = HtmlEncode($this->es_id->AdvancedSearch->SearchValue);
            $this->es_id->PlaceHolder = RemoveHtml($this->es_id->caption());
