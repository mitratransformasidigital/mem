 ...
 * Page class
 */
class MyassetDelete extends Myasset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MyassetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("myassetlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("myassetlist"); // Return to list
                return;
            }
        }
