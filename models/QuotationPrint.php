...
/**
 * Table class for quotation_print
 */
class QuotationPrint extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'quotation_print';
        $this->TableName = 'quotation_print';
        ...
        // quotation_id
        $this->quotation_id = new ReportField('quotation_print', 'quotation_print', 'x_quotation_id', 'quotation_id', '`quotation_id`', '`quotation_id`', 3, 11, -1, false, '`quotation_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // quotation_no
        $this->quotation_no = new ReportField('quotation_print', 'quotation_print', 'x_quotation_no', 'quotation_no', '`quotation_no`', '`quotation_no`', 200, 50, -1, false, '`quotation_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->quotation_no->GroupingFieldId = 2;
        ...
        // quotation_date
        $this->quotation_date = new ReportField('quotation_print', 'quotation_print', 'x_quotation_date', 'quotation_date', '`quotation_date`', '`quotation_date`', 200, 40, -1, false, '`quotation_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // customer_name
        $this->customer_name = new ReportField('quotation_print', 'quotation_print', 'x_customer_name', 'customer_name', '`customer_name`', '`customer_name`', 200, 100, -1, false, '`customer_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone_number
        $this->phone_number = new ReportField('quotation_print', 'quotation_print', 'x_phone_number', 'phone_number', '`phone_number`', '`phone_number`', 200, 50, -1, false, '`phone_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // contact
        $this->contact = new ReportField('quotation_print', 'quotation_print', 'x_contact', 'contact', '`contact`', '`contact`', 200, 100, -1, false, '`contact`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // city
        $this->city = new ReportField('quotation_print', 'quotation_print', 'x_city', 'city', '`city`', '`city`', 200, 50, -1, false, '`city`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_name
        $this->employee_name = new ReportField('quotation_print', 'quotation_print', 'x_employee_name', 'employee_name', '`employee_name`', '`employee_name`', 200, 150, -1, false, '`employee_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rate
        $this->rate = new ReportField('quotation_print', 'quotation_print', 'x_rate', 'rate', '`rate`', '`rate`', 3, 11, -1, false, '`rate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // qty
        $this->qty = new ReportField('quotation_print', 'quotation_print', 'x_qty', 'qty', '`qty`', '`qty`', 3, 11, -1, false, '`qty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // total
        $this->total = new ReportField('quotation_print', 'quotation_print', 'x_total', 'total', '`total`', '`total`', 20, 21, -1, false, '`total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // customer_address
        $this->customer_address = new ReportField('quotation_print', 'quotation_print', 'x_customer_address', 'customer_address', '`customer_address`', '`customer_address`', 201, 300, -1, false, '`customer_address`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("COUNT(*) AS `cnt_employee_name`, SUM(`rate`) AS `sum_rate`, SUM(`total`) AS `sum_total`");
    }
