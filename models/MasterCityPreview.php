 ...
 * Page class
 */
class MasterCityPreview extends MasterCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterCityPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "master_province") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_province&" . GetForeignKeyUrl("fk_province_id", $this->province_id->QueryStringValue) . "";
        }
        return $url;
    }
