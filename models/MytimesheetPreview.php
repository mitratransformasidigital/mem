 ...
 * Page class
 */
class MytimesheetPreview extends Mytimesheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MytimesheetPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "myprofile") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=myprofile&" . GetForeignKeyUrl("fk_employee_username", $this->employee_username->QueryStringValue) . "";
        }
        return $url;
    }
