...
class MasterPositionSearch extends MasterPosition
{
    ...
    // Page object name
    public $PageObjName = "MasterPositionSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "masterpositionlist" . "?" . $srchStr;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->position->EditCustomAttributes = "";
            if (!$this->position->Raw) {
                $this->position->AdvancedSearch->SearchValue2 = HtmlDecode($this->position->AdvancedSearch->SearchValue2);
            }
            $this->position->EditValue2 = HtmlEncode($this->position->AdvancedSearch->SearchValue2);
            $this->position->PlaceHolder = RemoveHtml($this->position->caption());
