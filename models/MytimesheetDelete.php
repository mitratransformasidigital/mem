 ...
 * Page class
 */
class MytimesheetDelete extends Mytimesheet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MytimesheetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("mytimesheetlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("mytimesheetlist"); // Return to list
                return;
            }
        }
