...
class ActivityList extends Activity
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->activity_date->AdvancedSearch->toJson(), ","); // Field activity_date
        ...
        $filterList = Concat($filterList, $this->document->AdvancedSearch->toJson(), ","); // Field document
    ...
    protected function restoreFilterList()
    {
        ...
        // Field activity_date
        $this->activity_date->AdvancedSearch->SearchValue = @$filter["x_activity_date"];
        $this->activity_date->AdvancedSearch->SearchOperator = @$filter["z_activity_date"];
        $this->activity_date->AdvancedSearch->SearchCondition = @$filter["v_activity_date"];
        $this->activity_date->AdvancedSearch->SearchValue2 = @$filter["y_activity_date"];
        $this->activity_date->AdvancedSearch->SearchOperator2 = @$filter["w_activity_date"];
        $this->activity_date->AdvancedSearch->save();
        ...
        // Field document
        $this->document->AdvancedSearch->SearchValue = @$filter["x_document"];
        $this->document->AdvancedSearch->SearchOperator = @$filter["z_document"];
        $this->document->AdvancedSearch->SearchCondition = @$filter["v_document"];
        $this->document->AdvancedSearch->SearchValue2 = @$filter["y_document"];
        $this->document->AdvancedSearch->SearchOperator2 = @$filter["w_document"];
        $this->document->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->activity_date, $default, false); // activity_date
        ...
        $this->buildSearchSql($where, $this->document, $default, false); // document
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->activity_date->AdvancedSearch->save(); // activity_date
            ...
            $this->document->AdvancedSearch->save(); // document
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->document, $arKeywords, $type);
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->activity_date->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->document->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->activity_date->AdvancedSearch->unsetSession();
                ...
                $this->document->AdvancedSearch->unsetSession();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->activity_date); // activity_date
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`activity_date` DESC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->activity_date->getSort() != "") {
                    $useDefaultSort = false;
                }
                if ($useDefaultSort) {
                    $this->activity_date->setSort("DESC");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.factivitylist, url:'" . GetUrl($this->MultiDeleteUrl) . "', data:{action:'show'}});return false;\">" . $Language->phrase("DeleteSelectedLink") . "</a>";
        $item->Visible = $Security->canDelete();

        // Add multi update
        $item = &$option->add("multiupdate");
        $item->Body = "<a class=\"ew-action ew-multi-update\" title=\"" . HtmlTitle($Language->phrase("UpdateSelectedLink")) . "\" data-table=\"activity\" data-caption=\"" . HtmlTitle($Language->phrase("UpdateSelectedLink")) . "\" href=\"#\" onclick=\"return ew.submitAction(event, {f:document.factivitylist,url:'" . GetUrl($this->MultiUpdateUrl) . "'});return false;\">" . $Language->phrase("UpdateSelectedLink") . "</a>";
        $item->Visible = $Security->canEdit();
    ...
    protected function loadSearchValues()
    {
        ...
        // activity_date
        if (!$this->isAddOrEdit() && $this->activity_date->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->activity_date->AdvancedSearch->SearchValue != "" || $this->activity_date->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // document
        if (!$this->isAddOrEdit() && $this->document->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->document->AdvancedSearch->SearchValue != "" || $this->document->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"activitysearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        $item->Visible = true;
