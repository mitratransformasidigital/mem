 ...
 * Page class
 */
class PermitDelete extends Permit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("permitlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("permitlist"); // Return to list
                return;
            }
        }
