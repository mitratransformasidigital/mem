...
class MasterOfficeSearch extends MasterOffice
{
    ...
    // Page object name
    public $PageObjName = "MasterOfficeSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "masterofficelist" . "?" . $srchStr;
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->office); // office
        $this->buildSearchUrl($srchUrl, $this->address); // address
        $this->buildSearchUrl($srchUrl, $this->city_id); // city_id
        $this->buildSearchUrl($srchUrl, $this->phone_number); // phone_number
        $this->buildSearchUrl($srchUrl, $this->contact_name); // contact_name
    ...
    protected function loadSearchValues()
    {
        // Load search values
        $hasValue = false;
        if ($this->office->AdvancedSearch->post()) {
            $hasValue = true;
        }
        ...
        if ($this->phone_number->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->contact_name->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->office->Raw) {
                $this->office->AdvancedSearch->SearchValue = HtmlDecode($this->office->AdvancedSearch->SearchValue);
            }
            $this->office->EditValue = HtmlEncode($this->office->AdvancedSearch->SearchValue);
            $this->office->PlaceHolder = RemoveHtml($this->office->caption());
            $this->office->EditAttrs["class"] = "form-control";
            $this->office->EditCustomAttributes = "";
            if (!$this->office->Raw) {
                $this->office->AdvancedSearch->SearchValue2 = HtmlDecode($this->office->AdvancedSearch->SearchValue2);
            }
            $this->office->EditValue2 = HtmlEncode($this->office->AdvancedSearch->SearchValue2);
            $this->office->PlaceHolder = RemoveHtml($this->office->caption());
            ...
            if (!$this->phone_number->Raw) {
                $this->phone_number->AdvancedSearch->SearchValue = HtmlDecode($this->phone_number->AdvancedSearch->SearchValue);
            }
            $this->phone_number->EditValue = HtmlEncode($this->phone_number->AdvancedSearch->SearchValue);
            $this->phone_number->PlaceHolder = RemoveHtml($this->phone_number->caption());
            $this->phone_number->EditAttrs["class"] = "form-control";
            $this->phone_number->EditCustomAttributes = "";
            if (!$this->phone_number->Raw) {
                $this->phone_number->AdvancedSearch->SearchValue2 = HtmlDecode($this->phone_number->AdvancedSearch->SearchValue2);
            }
            $this->phone_number->EditValue2 = HtmlEncode($this->phone_number->AdvancedSearch->SearchValue2);
            $this->phone_number->PlaceHolder = RemoveHtml($this->phone_number->caption());
            ...
            if (!$this->contact_name->Raw) {
                $this->contact_name->AdvancedSearch->SearchValue = HtmlDecode($this->contact_name->AdvancedSearch->SearchValue);
            }
            $this->contact_name->EditValue = HtmlEncode($this->contact_name->AdvancedSearch->SearchValue);
            $this->contact_name->PlaceHolder = RemoveHtml($this->contact_name->caption());
            $this->contact_name->EditAttrs["class"] = "form-control";
            $this->contact_name->EditCustomAttributes = "";
            if (!$this->contact_name->Raw) {
                $this->contact_name->AdvancedSearch->SearchValue2 = HtmlDecode($this->contact_name->AdvancedSearch->SearchValue2);
            }
            $this->contact_name->EditValue2 = HtmlEncode($this->contact_name->AdvancedSearch->SearchValue2);
            $this->contact_name->PlaceHolder = RemoveHtml($this->contact_name->caption());
