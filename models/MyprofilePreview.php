 ...
 * Page class
 */
class MyprofilePreview extends Myprofile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MyprofilePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "master_office") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_office&" . GetForeignKeyUrl("fk_office_id", $this->office_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "master_position") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_position&" . GetForeignKeyUrl("fk_position_id", $this->position_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "master_skill") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_skill&" . GetForeignKeyUrl("fk_skill_id", $this->skill_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "master_status") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_status&" . GetForeignKeyUrl("fk_status_id", $this->status_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "master_city") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=master_city&" . GetForeignKeyUrl("fk_city_id", $this->city_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "master_office") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->office_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "master_position") {
            $find = "`position_id`=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->position_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "master_skill") {
            $find = "`skill_id`=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->skill_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "master_status") {
            $find = "`status_id`=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->status_id->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "master_city") {
            $find = "`city_id`=";
            ...
            if ($x !== false) {
                ...
                $val = substr($f, $x);
                $val = $this->unquoteValue($val, "DB");
                 $this->city_id->setQueryStringValue($val);
            }
        }
    }
