 ...
 * Page class
 */
class MasterCityUpdate extends MasterCity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterCityUpdate";
    ...
    public function run()
    {
        ...
        if (count($this->RecKeys) <= 0) {
            $this->terminate("mastercitylist"); // No records selected, return to list
            return;
        }
        if ($this->isUpdate()) {
        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while (!$rs->EOF) {
                if ($i == 1) {
                    ...
                    if (!CompareValue($this->city->DbValue, $rs->fields['city'])) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // city_id
            $this->city_id->setDbValueDef($rsnew, $this->city_id->CurrentValue, "", $this->city_id->ReadOnly || $this->city_id->MultiUpdate != "1");
