 ...
 * Page class
 */
class MasterOfficeView extends MasterOffice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterOfficeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("office_id") ?? Route("office_id")) !== null) {
            $this->RecKey["office_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("office_id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("office_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("office_id") ?? Route("office_id")) !== null) {
                ...
                $this->RecKey["office_id"] = $this->office_id->QueryStringValue;
            } elseif (Post("office_id") !== null) {
                $this->office_id->setFormValue(Post("office_id"));
                $this->RecKey["office_id"] = $this->office_id->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("masterofficelist"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->office_id->CurrentValue, $this->Recordset->fields['office_id'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "masterofficelist"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "masterofficelist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("myprofilelist?" . Config("TABLE_SHOW_MASTER") . "=master_office&" . GetForeignKeyUrl("fk_office_id", $this->office_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("employeelist?" . Config("TABLE_SHOW_MASTER") . "=master_office&" . GetForeignKeyUrl("fk_office_id", $this->office_id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fmaster_officeview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fmaster_officeview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fmaster_officeview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
