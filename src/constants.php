...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "17.0.3");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "prjMitralPHP"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{83F75968-657B-46AA-B0FF-ABCCF02B6D71}"); // Project ID
