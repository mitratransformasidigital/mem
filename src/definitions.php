...
return [
    ...
    "v_quotation_list" => \DI\create(VQuotationList::class),
    "quotation_print" => \DI\create(QuotationPrint::class),
    "master_work_date" => \DI\create(MasterWorkDate::class),
    "v_timesheet_list" => \DI\create(VTimesheetList::class),
    "welcome" => \DI\create(Welcome::class),
    "offering" => \DI\create(Offering::class),
    "offering_detail" => \DI\create(OfferingDetail::class),
    "v_offering_list" => \DI\create(VOfferingList::class),
    "offering_print" => \DI\create(OfferingPrint::class),
