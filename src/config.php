...
$CONFIG = [
    ...
    "RANDOM_KEY" => '4kZloexb7o44hebY', // Random key for encryption
    ...
    "ADMIN_PASSWORD" => "yudhabektisetiana", // Administrator password
    ...
    "LOGIN_USERNAME_FIELD_NAME" => "employee_username",
    "LOGIN_PASSWORD_FIELD_NAME" => "employee_password",
    "USER_ID_FIELD_NAME" => "",
    "PARENT_USER_ID_FIELD_NAME" => "",
    "USER_LEVEL_FIELD_NAME" => "user_level",
    "USER_PROFILE_FIELD_NAME" => "",
    "REGISTER_ACTIVATE_FIELD_NAME" => "employee_name",
    "USER_EMAIL_FIELD_NAME" => "employee_email",

    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`employee`",
    "USER_NAME_FILTER" => "(`employee_username` = '%u')",
    "USER_ID_FILTER" => "",
    "USER_EMAIL_FILTER" => "(`employee_email` = '%e')",
