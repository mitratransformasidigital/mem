...
loadjs.ready("head", function () {
    ...
    // Validate form
    femployee_assetadd.validate = function () {
    ...
    // Form_CustomValidate
    femployee_assetadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_assetadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_assetadd.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    loadjs.done("femployee_assetadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_assetadd" id="femployee_assetadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_assetadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetadd", "x_asset_received", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_assetadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetadd", "x_asset_return", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="fa_x_asset_picture" id= "fa_x_asset_picture" value="0">
