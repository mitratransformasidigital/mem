...
// Page object
$EmployeeAssetSearch = &$Page;
?>
<script>
if (!ew.vars.tables.employee_asset) ew.vars.tables.employee_asset = <?= JsonEncode(GetClientVar("tables", "employee_asset")) ?>;
var currentForm, currentPageID;
var femployee_assetsearch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    <?php if ($Page->IsModal) { ?>
    femployee_assetsearch = currentAdvancedSearchForm = new ew.Form("femployee_assetsearch", "search");
    <?php } else { ?>
    femployee_assetsearch = currentForm = new ew.Form("femployee_assetsearch", "search");
    <?php } ?>
    currentPageID = ew.PAGE_ID = "search";

    // Add fields
    var fields = ew.vars.tables.employee_asset.fields;
    femployee_assetsearch.addFields([
    ...
    // Set invalid fields
    $(function() {
        femployee_assetsearch.setInvalid();
    });

    // Validate form
    femployee_assetsearch.validate = function () {
    ...
    // Form_CustomValidate
    femployee_assetsearch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_assetsearch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_assetsearch.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    loadjs.done("femployee_assetsearch");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_assetsearch" id="femployee_assetsearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->employee_username->Visible) { // employee_username ?>
    <div id="r_employee_username" class="form-group row">
        <label for="x_employee_username" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_employee_username"><?= $Page->employee_username->caption() ?></span>
...
<input type="hidden" name="z_employee_username" id="z_employee_username" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->employee_username->cellAttributes() ?>>
            <span id="el_employee_asset_employee_username" class="ew-search-field">
    <select
...
<?php if ($Page->asset_name->Visible) { // asset_name ?>
    <div id="r_asset_name" class="form-group row">
        <label for="x_asset_name" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_asset_name"><?= $Page->asset_name->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->asset_name->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_asset_name" class="ew-search-field">
<input type="<?= $Page->asset_name->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_name" name="x_asset_name" id="x_asset_name" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->asset_name->getPlaceHolder()) ?>" value="<?= $Page->asset_name->EditValue ?>"<?= $Page->asset_name->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->asset_name->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_asset_name" class="ew-search-field2 d-none">
<input type="<?= $Page->asset_name->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_name" name="y_asset_name" id="y_asset_name" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->asset_name->getPlaceHolder()) ?>" value="<?= $Page->asset_name->EditValue2 ?>"<?= $Page->asset_name->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->asset_name->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->year->Visible) { // year ?>
    <div id="r_year" class="form-group row">
        <label for="x_year" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_year"><?= $Page->year->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->year->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_year" class="ew-search-field">
<input type="<?= $Page->year->getInputTextType() ?>" data-table="employee_asset" data-field="x_year" name="x_year" id="x_year" size="30" placeholder="<?= HtmlEncode($Page->year->getPlaceHolder()) ?>" value="<?= $Page->year->EditValue ?>"<?= $Page->year->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->year->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_year" class="ew-search-field2 d-none">
<input type="<?= $Page->year->getInputTextType() ?>" data-table="employee_asset" data-field="x_year" name="y_year" id="y_year" size="30" placeholder="<?= HtmlEncode($Page->year->getPlaceHolder()) ?>" value="<?= $Page->year->EditValue2 ?>"<?= $Page->year->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->year->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->serial_number->Visible) { // serial_number ?>
    <div id="r_serial_number" class="form-group row">
        <label for="x_serial_number" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_serial_number"><?= $Page->serial_number->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->serial_number->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_serial_number" class="ew-search-field">
<input type="<?= $Page->serial_number->getInputTextType() ?>" data-table="employee_asset" data-field="x_serial_number" name="x_serial_number" id="x_serial_number" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->serial_number->getPlaceHolder()) ?>" value="<?= $Page->serial_number->EditValue ?>"<?= $Page->serial_number->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->serial_number->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_serial_number" class="ew-search-field2 d-none">
<input type="<?= $Page->serial_number->getInputTextType() ?>" data-table="employee_asset" data-field="x_serial_number" name="y_serial_number" id="y_serial_number" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->serial_number->getPlaceHolder()) ?>" value="<?= $Page->serial_number->EditValue2 ?>"<?= $Page->serial_number->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->serial_number->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->value->Visible) { // value ?>
    <div id="r_value" class="form-group row">
        <label for="x_value" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_value"><?= $Page->value->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->value->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_value" class="ew-search-field">
<input type="<?= $Page->value->getInputTextType() ?>" data-table="employee_asset" data-field="x_value" name="x_value" id="x_value" size="30" placeholder="<?= HtmlEncode($Page->value->getPlaceHolder()) ?>" value="<?= $Page->value->EditValue ?>"<?= $Page->value->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->value->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_value" class="ew-search-field2 d-none">
<input type="<?= $Page->value->getInputTextType() ?>" data-table="employee_asset" data-field="x_value" name="y_value" id="y_value" size="30" placeholder="<?= HtmlEncode($Page->value->getPlaceHolder()) ?>" value="<?= $Page->value->EditValue2 ?>"<?= $Page->value->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->value->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->asset_received->Visible) { // asset_received ?>
    <div id="r_asset_received" class="form-group row">
        <label for="x_asset_received" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_asset_received"><?= $Page->asset_received->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->asset_received->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_asset_received" class="ew-search-field">
<input type="<?= $Page->asset_received->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_received" data-format="5" name="x_asset_received" id="x_asset_received" placeholder="<?= HtmlEncode($Page->asset_received->getPlaceHolder()) ?>" value="<?= $Page->asset_received->EditValue ?>"<?= $Page->asset_received->editAttributes() ?>>
...
<script>
loadjs.ready(["femployee_assetsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetsearch", "x_asset_received", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_asset_received" class="ew-search-field2 d-none">
<input type="<?= $Page->asset_received->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_received" data-format="5" name="y_asset_received" id="y_asset_received" placeholder="<?= HtmlEncode($Page->asset_received->getPlaceHolder()) ?>" value="<?= $Page->asset_received->EditValue2 ?>"<?= $Page->asset_received->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->asset_received->getErrorMessage(false) ?></div>
<?php if (!$Page->asset_received->ReadOnly && !$Page->asset_received->Disabled && !isset($Page->asset_received->EditAttrs["readonly"]) && !isset($Page->asset_received->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["femployee_assetsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetsearch", "y_asset_received", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->asset_return->Visible) { // asset_return ?>
    <div id="r_asset_return" class="form-group row">
        <label for="x_asset_return" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_asset_return"><?= $Page->asset_return->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->asset_return->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_asset_return" class="ew-search-field">
<input type="<?= $Page->asset_return->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_return" data-format="5" name="x_asset_return" id="x_asset_return" placeholder="<?= HtmlEncode($Page->asset_return->getPlaceHolder()) ?>" value="<?= $Page->asset_return->EditValue ?>"<?= $Page->asset_return->editAttributes() ?>>
...
<script>
loadjs.ready(["femployee_assetsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetsearch", "x_asset_return", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_asset_return" class="ew-search-field2 d-none">
<input type="<?= $Page->asset_return->getInputTextType() ?>" data-table="employee_asset" data-field="x_asset_return" data-format="5" name="y_asset_return" id="y_asset_return" placeholder="<?= HtmlEncode($Page->asset_return->getPlaceHolder()) ?>" value="<?= $Page->asset_return->EditValue2 ?>"<?= $Page->asset_return->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->asset_return->getErrorMessage(false) ?></div>
<?php if (!$Page->asset_return->ReadOnly && !$Page->asset_return->Disabled && !isset($Page->asset_return->EditAttrs["readonly"]) && !isset($Page->asset_return->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["femployee_assetsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_assetsearch", "y_asset_return", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->notes->Visible) { // notes ?>
    <div id="r_notes" class="form-group row">
        <label for="x_notes" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_asset_notes"><?= $Page->notes->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->notes->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_asset_notes" class="ew-search-field">
<input type="<?= $Page->notes->getInputTextType() ?>" data-table="employee_asset" data-field="x_notes" name="x_notes" id="x_notes" size="35" placeholder="<?= HtmlEncode($Page->notes->getPlaceHolder()) ?>" value="<?= $Page->notes->EditValue ?>"<?= $Page->notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->notes->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_asset_notes" class="ew-search-field2 d-none">
<input type="<?= $Page->notes->getInputTextType() ?>" data-table="employee_asset" data-field="x_notes" name="y_notes" id="y_notes" size="35" placeholder="<?= HtmlEncode($Page->notes->getPlaceHolder()) ?>" value="<?= $Page->notes->EditValue2 ?>"<?= $Page->notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->notes->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
