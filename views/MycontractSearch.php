...
// Page object
$MycontractSearch = &$Page;
?>
<script>
if (!ew.vars.tables.mycontract) ew.vars.tables.mycontract = <?= JsonEncode(GetClientVar("tables", "mycontract")) ?>;
var currentForm, currentPageID;
var fmycontractsearch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    <?php if ($Page->IsModal) { ?>
    fmycontractsearch = currentAdvancedSearchForm = new ew.Form("fmycontractsearch", "search");
    <?php } else { ?>
    fmycontractsearch = currentForm = new ew.Form("fmycontractsearch", "search");
    <?php } ?>
    currentPageID = ew.PAGE_ID = "search";

    // Add fields
    var fields = ew.vars.tables.mycontract.fields;
    fmycontractsearch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fmycontractsearch.setInvalid();
    });

    // Validate form
    fmycontractsearch.validate = function () {
    ...
    // Form_CustomValidate
    fmycontractsearch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmycontractsearch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fmycontractsearch.lists.office_id = <?= $Page->office_id->toClientList($Page) ?>;
    loadjs.done("fmycontractsearch");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmycontractsearch" id="fmycontractsearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->salary->Visible) { // salary ?>
    <div id="r_salary" class="form-group row">
        <label for="x_salary" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_salary"><?= $Page->salary->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->salary->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_mycontract_salary" class="ew-search-field">
<input type="<?= $Page->salary->getInputTextType() ?>" data-table="mycontract" data-field="x_salary" name="x_salary" id="x_salary" size="30" placeholder="<?= HtmlEncode($Page->salary->getPlaceHolder()) ?>" value="<?= $Page->salary->EditValue ?>"<?= $Page->salary->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->salary->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_mycontract_salary" class="ew-search-field2 d-none">
<input type="<?= $Page->salary->getInputTextType() ?>" data-table="mycontract" data-field="x_salary" name="y_salary" id="y_salary" size="30" placeholder="<?= HtmlEncode($Page->salary->getPlaceHolder()) ?>" value="<?= $Page->salary->EditValue2 ?>"<?= $Page->salary->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->salary->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->bonus->Visible) { // bonus ?>
    <div id="r_bonus" class="form-group row">
        <label for="x_bonus" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_bonus"><?= $Page->bonus->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->bonus->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_mycontract_bonus" class="ew-search-field">
<input type="<?= $Page->bonus->getInputTextType() ?>" data-table="mycontract" data-field="x_bonus" name="x_bonus" id="x_bonus" size="30" placeholder="<?= HtmlEncode($Page->bonus->getPlaceHolder()) ?>" value="<?= $Page->bonus->EditValue ?>"<?= $Page->bonus->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->bonus->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_mycontract_bonus" class="ew-search-field2 d-none">
<input type="<?= $Page->bonus->getInputTextType() ?>" data-table="mycontract" data-field="x_bonus" name="y_bonus" id="y_bonus" size="30" placeholder="<?= HtmlEncode($Page->bonus->getPlaceHolder()) ?>" value="<?= $Page->bonus->EditValue2 ?>"<?= $Page->bonus->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->bonus->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->thr->Visible) { // thr ?>
    <div id="r_thr" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_thr"><?= $Page->thr->caption() ?></span>
        </label>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->thr->isInvalidClass() ?>" data-table="mycontract" data-field="x_thr" name="x_thr[]" id="x_thr_538441" value="1"<?= ConvertToBool($Page->thr->AdvancedSearch->SearchValue) ? " checked" : "" ?><?= $Page->thr->editAttributes() ?>>
    <label class="custom-control-label" for="x_thr_538441"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->thr->isInvalidClass() ?>" data-table="mycontract" data-field="x_thr" name="y_thr[]" id="y_thr_274789" value="1"<?= ConvertToBool($Page->thr->AdvancedSearch->SearchValue2) ? " checked" : "" ?><?= $Page->thr->editAttributes() ?>>
    <label class="custom-control-label" for="y_thr_274789"></label>
</div>
<div class="invalid-feedback"><?= $Page->thr->getErrorMessage(false) ?></div>
</span>
        </div></div>
...
<?php if ($Page->contract_start->Visible) { // contract_start ?>
    <div id="r_contract_start" class="form-group row">
        <label for="x_contract_start" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_contract_start"><?= $Page->contract_start->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->contract_start->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_mycontract_contract_start" class="ew-search-field">
<input type="<?= $Page->contract_start->getInputTextType() ?>" data-table="mycontract" data-field="x_contract_start" name="x_contract_start" id="x_contract_start" placeholder="<?= HtmlEncode($Page->contract_start->getPlaceHolder()) ?>" value="<?= $Page->contract_start->EditValue ?>"<?= $Page->contract_start->editAttributes() ?>>
...
<script>
loadjs.ready(["fmycontractsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fmycontractsearch", "x_contract_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_mycontract_contract_start" class="ew-search-field2 d-none">
<input type="<?= $Page->contract_start->getInputTextType() ?>" data-table="mycontract" data-field="x_contract_start" name="y_contract_start" id="y_contract_start" placeholder="<?= HtmlEncode($Page->contract_start->getPlaceHolder()) ?>" value="<?= $Page->contract_start->EditValue2 ?>"<?= $Page->contract_start->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->contract_start->getErrorMessage(false) ?></div>
<?php if (!$Page->contract_start->ReadOnly && !$Page->contract_start->Disabled && !isset($Page->contract_start->EditAttrs["readonly"]) && !isset($Page->contract_start->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fmycontractsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fmycontractsearch", "y_contract_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->contract_end->Visible) { // contract_end ?>
    <div id="r_contract_end" class="form-group row">
        <label for="x_contract_end" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_contract_end"><?= $Page->contract_end->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->contract_end->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_mycontract_contract_end" class="ew-search-field">
<input type="<?= $Page->contract_end->getInputTextType() ?>" data-table="mycontract" data-field="x_contract_end" name="x_contract_end" id="x_contract_end" placeholder="<?= HtmlEncode($Page->contract_end->getPlaceHolder()) ?>" value="<?= $Page->contract_end->EditValue ?>"<?= $Page->contract_end->editAttributes() ?>>
...
<script>
loadjs.ready(["fmycontractsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fmycontractsearch", "x_contract_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_mycontract_contract_end" class="ew-search-field2 d-none">
<input type="<?= $Page->contract_end->getInputTextType() ?>" data-table="mycontract" data-field="x_contract_end" name="y_contract_end" id="y_contract_end" placeholder="<?= HtmlEncode($Page->contract_end->getPlaceHolder()) ?>" value="<?= $Page->contract_end->EditValue2 ?>"<?= $Page->contract_end->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->contract_end->getErrorMessage(false) ?></div>
<?php if (!$Page->contract_end->ReadOnly && !$Page->contract_end->Disabled && !isset($Page->contract_end->EditAttrs["readonly"]) && !isset($Page->contract_end->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fmycontractsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fmycontractsearch", "y_contract_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->office_id->Visible) { // office_id ?>
    <div id="r_office_id" class="form-group row">
        <label for="x_office_id" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_office_id"><?= $Page->office_id->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_office_id" id="z_office_id" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->office_id->cellAttributes() ?>>
            <span id="el_mycontract_office_id" class="ew-search-field">
    <select
        id="x_office_id"
        name="x_office_id"
...
<?php if ($Page->notes->Visible) { // notes ?>
    <div id="r_notes" class="form-group row">
        <label for="x_notes" class="<?= $Page->LeftColumnClass ?>"><span id="elh_mycontract_notes"><?= $Page->notes->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->notes->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_mycontract_notes" class="ew-search-field">
<input type="<?= $Page->notes->getInputTextType() ?>" data-table="mycontract" data-field="x_notes" name="x_notes" id="x_notes" size="35" placeholder="<?= HtmlEncode($Page->notes->getPlaceHolder()) ?>" value="<?= $Page->notes->EditValue ?>"<?= $Page->notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->notes->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_mycontract_notes" class="ew-search-field2 d-none">
<input type="<?= $Page->notes->getInputTextType() ?>" data-table="mycontract" data-field="x_notes" name="y_notes" id="y_notes" size="35" placeholder="<?= HtmlEncode($Page->notes->getPlaceHolder()) ?>" value="<?= $Page->notes->EditValue2 ?>"<?= $Page->notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->notes->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
