...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmaster_shiftedit.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_shiftedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_shiftedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_shiftedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmaster_shiftedit" id="fmaster_shiftedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_sunday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_sunday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_monday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_monday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_tuesday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_tuesday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_wednesday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_wednesday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_thursday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_thursday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_friday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_friday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_saturday_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_shiftedit", "timepicker"], function() {
    ew.createTimePicker("fmaster_shiftedit", "x_saturday_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":15});
});
</script>
<?php } ?>
</span>
...
<span id="el_master_shift_shift_id">
<input type="hidden" data-table="master_shift" data-field="x_shift_id" data-hidden="1" name="x_shift_id" id="x_shift_id" value="<?= HtmlEncode($Page->shift_id->CurrentValue) ?>">
</span>
...
<?php
    if (in_array("master_holiday", explode(",", $Page->getCurrentDetailTable())) && $master_holiday->DetailEdit) {
