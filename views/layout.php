...
<meta name="generator" content="PHPMaker 2021.0.3">
</head>
...
<div class="wrapper ew-layout">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="http://mitral.co.id">
                <span class="brand-text">Mitra Tranformasi Digital</span>
            </a>
        </ul>
        <!-- Right navbar links -->
    ...
    <aside class="<?= Config("SIDEBAR_CLASS") ?>">
        ...
        <a href="http://mitral.co.id" class="brand-link">
            <span class="brand-text">Mitra Tranformasi Digital</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
