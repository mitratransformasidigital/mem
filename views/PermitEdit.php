...
loadjs.ready(["fpermitedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpermitedit", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpermitedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpermitedit", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
