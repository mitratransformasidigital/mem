...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmyprofileupdate.validate = function () {
    ...
    // Form_CustomValidate
    fmyprofileupdate.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmyprofileupdate.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fmyprofileupdate.lists.city_id = <?= $Page->city_id->toClientList($Page) ?>;
    fmyprofileupdate.lists.position_id = <?= $Page->position_id->toClientList($Page) ?>;
    fmyprofileupdate.lists.religion = <?= $Page->religion->toClientList($Page) ?>;
    fmyprofileupdate.lists.status_id = <?= $Page->status_id->toClientList($Page) ?>;
    fmyprofileupdate.lists.skill_id = <?= $Page->skill_id->toClientList($Page) ?>;
    fmyprofileupdate.lists.office_id = <?= $Page->office_id->toClientList($Page) ?>;
    loadjs.done("fmyprofileupdate");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmyprofileupdate" id="fmyprofileupdate" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php } ?>
<div id="tbl_myprofileupdate" class="ew-update-div"><!-- page -->
    ...
    <div id="r_employee_username" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->employee_username->cellAttributes() ?>>
                ...
                <input type="hidden" data-table="myprofile" data-field="x_employee_username" data-hidden="1" name="o_employee_username" id="o_employee_username" value="<?= HtmlEncode($Page->employee_username->OldValue ?? $Page->employee_username->CurrentValue) ?>">
            </div>
        </div>
    </div>
<?php } ?>
    ...
    <div id="r_birth_date" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->birth_date->cellAttributes() ?>>
                ...
                <input type="<?= $Page->birth_date->getInputTextType() ?>" data-table="myprofile" data-field="x_birth_date" data-format="5" name="x_birth_date" id="x_birth_date" placeholder="<?= HtmlEncode($Page->birth_date->getPlaceHolder()) ?>" value="<?= $Page->birth_date->EditValue ?>"<?= $Page->birth_date->editAttributes() ?> aria-describedby="x_birth_date_help">
                ...
                <script>
                loadjs.ready(["fmyprofileupdate", "datetimepicker"], function() {
                    ew.createDateTimePicker("fmyprofileupdate", "x_birth_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
                });
                </script>
                <?php } ?>
                </span>
    ...
    <div id="r_nik" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->nik->cellAttributes() ?>>
                ...
                <input type="<?= $Page->nik->getInputTextType() ?>" data-table="myprofile" data-field="x_nik" name="x_nik" id="x_nik" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->nik->getPlaceHolder()) ?>" value="<?= $Page->nik->EditValue ?>"<?= $Page->nik->editAttributes() ?> aria-describedby="x_nik_help">
    ...
    <div id="r_npwp" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->npwp->cellAttributes() ?>>
                ...
                <input type="<?= $Page->npwp->getInputTextType() ?>" data-table="myprofile" data-field="x_npwp" name="x_npwp" id="x_npwp" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->npwp->getPlaceHolder()) ?>" value="<?= $Page->npwp->EditValue ?>"<?= $Page->npwp->editAttributes() ?> aria-describedby="x_npwp_help">
    ...
    <div id="r_address" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->address->cellAttributes() ?>>
                ...
                <input type="<?= $Page->address->getInputTextType() ?>" data-table="myprofile" data-field="x_address" name="x_address" id="x_address" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->address->getPlaceHolder()) ?>" value="<?= $Page->address->EditValue ?>"<?= $Page->address->editAttributes() ?> aria-describedby="x_address_help">
    ...
    <div id="r_bank_name" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->bank_name->cellAttributes() ?>>
                ...
                <input type="<?= $Page->bank_name->getInputTextType() ?>" data-table="myprofile" data-field="x_bank_name" name="x_bank_name" id="x_bank_name" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->bank_name->getPlaceHolder()) ?>" value="<?= $Page->bank_name->EditValue ?>"<?= $Page->bank_name->editAttributes() ?> aria-describedby="x_bank_name_help">
    ...
    <div id="r_technical_skill" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->technical_skill->cellAttributes() ?>>
                ...
                <textarea data-table="myprofile" data-field="x_technical_skill" name="x_technical_skill" id="x_technical_skill" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->technical_skill->getPlaceHolder()) ?>"<?= $Page->technical_skill->editAttributes() ?> aria-describedby="x_technical_skill_help"><?= $Page->technical_skill->EditValue ?></textarea>
    ...
    <div id="r_about_me" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->about_me->cellAttributes() ?>>
                ...
                <textarea data-table="myprofile" data-field="x_about_me" name="x_about_me" id="x_about_me" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->about_me->getPlaceHolder()) ?>"<?= $Page->about_me->editAttributes() ?> aria-describedby="x_about_me_help"><?= $Page->about_me->EditValue ?></textarea>
    ...
    <div id="r_hire_date" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->hire_date->cellAttributes() ?>>
                ...
                <input type="<?= $Page->hire_date->getInputTextType() ?>" data-table="myprofile" data-field="x_hire_date" data-format="5" name="x_hire_date" id="x_hire_date" placeholder="<?= HtmlEncode($Page->hire_date->getPlaceHolder()) ?>" value="<?= $Page->hire_date->EditValue ?>"<?= $Page->hire_date->editAttributes() ?> aria-describedby="x_hire_date_help">
                ...
                <script>
                loadjs.ready(["fmyprofileupdate", "datetimepicker"], function() {
                    ew.createDateTimePicker("fmyprofileupdate", "x_hire_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
                });
                </script>
                <?php } ?>
                </span>
    ...
    <div id="r_termination_date" class="form-group row">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div <?= $Page->termination_date->cellAttributes() ?>>
                ...
                <script>
                loadjs.ready(["fmyprofileupdate", "datetimepicker"], function() {
                    ew.createDateTimePicker("fmyprofileupdate", "x_termination_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
                });
                </script>
                <?php } ?>
                </span>
