...
// Page object
$EmployeeQuotationDetailAdd = &$Page;
?>
<script>
...
var femployee_quotation_detailadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_quotation_detailadd = currentForm = new ew.Form("femployee_quotation_detailadd", "add");

    // Add fields
    var fields = ew.vars.tables.employee_quotation_detail.fields;
    femployee_quotation_detailadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_quotation_detailadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    femployee_quotation_detailadd.validate = function () {
    ...
    // Form_CustomValidate
    femployee_quotation_detailadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_quotation_detailadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_quotation_detailadd.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    loadjs.done("femployee_quotation_detailadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_quotation_detailadd" id="femployee_quotation_detailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
