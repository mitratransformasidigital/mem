...
loadjs.ready("head", function () {
    ...
    femployeeedit.lists.religion = <?= $Page->religion->toClientList($Page) ?>;
    femployeeedit.lists.city_id = <?= $Page->city_id->toClientList($Page) ?>;
    femployeeedit.lists.position_id = <?= $Page->position_id->toClientList($Page) ?>;
    femployeeedit.lists.status_id = <?= $Page->status_id->toClientList($Page) ?>;
    femployeeedit.lists.skill_id = <?= $Page->skill_id->toClientList($Page) ?>;
    femployeeedit.lists.office_id = <?= $Page->office_id->toClientList($Page) ?>;
    femployeeedit.lists.user_level = <?= $Page->user_level->toClientList($Page) ?>;
...
<input type="hidden" data-table="employee" data-field="x_employee_username" data-hidden="1" data-page="1" name="o_employee_username" id="o_employee_username" value="<?= HtmlEncode($Page->employee_username->OldValue ?? $Page->employee_username->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<div class="input-group">
    <input type="password" name="x_employee_password" id="x_employee_password" autocomplete="new-password" data-field="x_employee_password" value="<?= $Page->employee_password->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->employee_password->getPlaceHolder()) ?>"<?= $Page->employee_password->editAttributes() ?> aria-describedby="x_employee_password_help">
...
<input type="<?= $Page->birth_date->getInputTextType() ?>" data-table="employee" data-field="x_birth_date" data-page="1" data-format="5" name="x_birth_date" id="x_birth_date" placeholder="<?= HtmlEncode($Page->birth_date->getPlaceHolder()) ?>" value="<?= $Page->birth_date->EditValue ?>"<?= $Page->birth_date->editAttributes() ?> aria-describedby="x_birth_date_help">
...
loadjs.ready(["femployeeedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeedit", "x_birth_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->nik->Visible) { // nik ?>
    <div id="r_nik" class="form-group row">
        <label id="elh_employee_nik" for="x_nik" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nik->caption() ?><?= $Page->nik->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nik->cellAttributes() ?>>
<span id="el_employee_nik">
<input type="<?= $Page->nik->getInputTextType() ?>" data-table="employee" data-field="x_nik" data-page="1" name="x_nik" id="x_nik" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->nik->getPlaceHolder()) ?>" value="<?= $Page->nik->EditValue ?>"<?= $Page->nik->editAttributes() ?> aria-describedby="x_nik_help">
...
<?php if ($Page->npwp->Visible) { // npwp ?>
    <div id="r_npwp" class="form-group row">
        <label id="elh_employee_npwp" for="x_npwp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->npwp->caption() ?><?= $Page->npwp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->npwp->cellAttributes() ?>>
<span id="el_employee_npwp">
<input type="<?= $Page->npwp->getInputTextType() ?>" data-table="employee" data-field="x_npwp" data-page="1" name="x_npwp" id="x_npwp" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->npwp->getPlaceHolder()) ?>" value="<?= $Page->npwp->EditValue ?>"<?= $Page->npwp->editAttributes() ?> aria-describedby="x_npwp_help">
...
<input type="<?= $Page->address->getInputTextType() ?>" data-table="employee" data-field="x_address" data-page="1" name="x_address" id="x_address" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->address->getPlaceHolder()) ?>" value="<?= $Page->address->EditValue ?>"<?= $Page->address->editAttributes() ?> aria-describedby="x_address_help">
...
<?php if ($Page->city_id->Visible) { // city_id ?>
    <div id="r_city_id" class="form-group row">
        <label id="elh_employee_city_id" for="x_city_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->city_id->caption() ?><?= $Page->city_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->bank_number->Visible) { // bank_number ?>
    <div id="r_bank_number" class="form-group row">
        <label id="elh_employee_bank_number" for="x_bank_number" class="<?= $Page->LeftColumnClass ?>"><?= $Page->bank_number->caption() ?><?= $Page->bank_number->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->bank_name->Visible) { // bank_name ?>
    <div id="r_bank_name" class="form-group row">
        <label id="elh_employee_bank_name" for="x_bank_name" class="<?= $Page->LeftColumnClass ?>"><?= $Page->bank_name->caption() ?><?= $Page->bank_name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->bank_name->cellAttributes() ?>>
<span id="el_employee_bank_name">
<input type="<?= $Page->bank_name->getInputTextType() ?>" data-table="employee" data-field="x_bank_name" data-page="2" name="x_bank_name" id="x_bank_name" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->bank_name->getPlaceHolder()) ?>" value="<?= $Page->bank_name->EditValue ?>"<?= $Page->bank_name->editAttributes() ?> aria-describedby="x_bank_name_help">
...
<?php if ($Page->scan_ktp->Visible) { // scan_ktp ?>
    <div id="r_scan_ktp" class="form-group row">
        <label id="elh_employee_scan_ktp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->scan_ktp->caption() ?><?= $Page->scan_ktp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->scan_ktp->cellAttributes() ?>>
<span id="el_employee_scan_ktp">
<div id="fd_x_scan_ktp">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->scan_ktp->title() ?>" data-table="employee" data-field="x_scan_ktp" data-page="2" name="x_scan_ktp" id="x_scan_ktp" lang="<?= CurrentLanguageID() ?>"<?= $Page->scan_ktp->editAttributes() ?><?= ($Page->scan_ktp->ReadOnly || $Page->scan_ktp->Disabled) ? " disabled" : "" ?> aria-describedby="x_scan_ktp_help">
...
<input type="hidden" name="fa_x_scan_ktp" id= "fa_x_scan_ktp" value="<?= (Post("fa_x_scan_ktp") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->scan_npwp->Visible) { // scan_npwp ?>
    <div id="r_scan_npwp" class="form-group row">
        <label id="elh_employee_scan_npwp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->scan_npwp->caption() ?><?= $Page->scan_npwp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->scan_npwp->cellAttributes() ?>>
<span id="el_employee_scan_npwp">
<div id="fd_x_scan_npwp">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->scan_npwp->title() ?>" data-table="employee" data-field="x_scan_npwp" data-page="2" name="x_scan_npwp" id="x_scan_npwp" lang="<?= CurrentLanguageID() ?>"<?= $Page->scan_npwp->editAttributes() ?><?= ($Page->scan_npwp->ReadOnly || $Page->scan_npwp->Disabled) ? " disabled" : "" ?> aria-describedby="x_scan_npwp_help">
...
<input type="hidden" name="fa_x_scan_npwp" id= "fa_x_scan_npwp" value="<?= (Post("fa_x_scan_npwp") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->curiculum_vitae->Visible) { // curiculum_vitae ?>
    <div id="r_curiculum_vitae" class="form-group row">
        <label id="elh_employee_curiculum_vitae" class="<?= $Page->LeftColumnClass ?>"><?= $Page->curiculum_vitae->caption() ?><?= $Page->curiculum_vitae->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" name="fa_x_curiculum_vitae" id= "fa_x_curiculum_vitae" value="<?= (Post("fa_x_curiculum_vitae") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->position_id->Visible) { // position_id ?>
    <div id="r_position_id" class="form-group row">
        <label id="elh_employee_position_id" for="x_position_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->position_id->caption() ?><?= $Page->position_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->status_id->Visible) { // status_id ?>
    <div id="r_status_id" class="form-group row">
        <label id="elh_employee_status_id" for="x_status_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->status_id->caption() ?><?= $Page->status_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->skill_id->Visible) { // skill_id ?>
    <div id="r_skill_id" class="form-group row">
        <label id="elh_employee_skill_id" for="x_skill_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->skill_id->caption() ?><?= $Page->skill_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->office_id->Visible) { // office_id ?>
    <div id="r_office_id" class="form-group row">
        <label id="elh_employee_office_id" for="x_office_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->office_id->caption() ?><?= $Page->office_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->hire_date->Visible) { // hire_date ?>
    <div id="r_hire_date" class="form-group row">
        <label id="elh_employee_hire_date" for="x_hire_date" class="<?= $Page->LeftColumnClass ?>"><?= $Page->hire_date->caption() ?><?= $Page->hire_date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hire_date->cellAttributes() ?>>
<span id="el_employee_hire_date">
<input type="<?= $Page->hire_date->getInputTextType() ?>" data-table="employee" data-field="x_hire_date" data-page="3" data-format="5" name="x_hire_date" id="x_hire_date" placeholder="<?= HtmlEncode($Page->hire_date->getPlaceHolder()) ?>" value="<?= $Page->hire_date->EditValue ?>"<?= $Page->hire_date->editAttributes() ?> aria-describedby="x_hire_date_help">
...
<script>
loadjs.ready(["femployeeedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeedit", "x_hire_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployeeedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeedit", "x_termination_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->user_level->Visible) { // user_level ?>
    <div id="r_user_level" class="form-group row">
        <label id="elh_employee_user_level" for="x_user_level" class="<?= $Page->LeftColumnClass ?>"><?= $Page->user_level->caption() ?><?= $Page->user_level->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->about_me->Visible) { // about_me ?>
    <div id="r_about_me" class="form-group row">
        <label id="elh_employee_about_me" for="x_about_me" class="<?= $Page->LeftColumnClass ?>"><?= $Page->about_me->caption() ?><?= $Page->about_me->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->about_me->cellAttributes() ?>>
<span id="el_employee_about_me">
<textarea data-table="employee" data-field="x_about_me" data-page="4" name="x_about_me" id="x_about_me" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->about_me->getPlaceHolder()) ?>"<?= $Page->about_me->editAttributes() ?> aria-describedby="x_about_me_help"><?= $Page->about_me->EditValue ?></textarea>
