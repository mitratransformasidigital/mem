...
loadjs.ready("head", function () {
    ...
    fuserlevelpermissionsedit.addFields([
        ["userlevelid", [fields.userlevelid.required ? ew.Validators.required(fields.userlevelid.caption) : null, ew.Validators.integer], fields.userlevelid.isInvalid],
...
<?php } ?>
<form name="fuserlevelpermissionsedit" id="fuserlevelpermissionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
