...
// Page object
$MasterStatusView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fmaster_statusview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fmaster_statusview = currentForm = new ew.Form("fmaster_statusview", "view");
    loadjs.done("fmaster_statusview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="fmaster_statusview" id="fmaster_statusview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_master_status_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->description->Visible) { // description ?>
    <tr id="r_description">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_master_status_description"><?= $Page->description->caption() ?></span></td>
