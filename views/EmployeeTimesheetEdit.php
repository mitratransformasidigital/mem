...
var femployee_timesheetedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    femployee_timesheetedit = currentForm = new ew.Form("femployee_timesheetedit", "edit");

    // Add fields
    var fields = ew.vars.tables.employee_timesheet.fields;
    femployee_timesheetedit.addFields([
    ...
    // Validate form
    femployee_timesheetedit.validate = function () {
    ...
    // Form_CustomValidate
    femployee_timesheetedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_timesheetedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_timesheetedit.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    femployee_timesheetedit.lists.year = <?= $Page->year->toClientList($Page) ?>;
    femployee_timesheetedit.lists.month = <?= $Page->month->toClientList($Page) ?>;
    femployee_timesheetedit.lists.approved = <?= $Page->approved->toClientList($Page) ?>;
    loadjs.done("femployee_timesheetedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="femployee_timesheetedit" id="femployee_timesheetedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el_employee_timesheet_timesheet_id">
<input type="hidden" data-table="employee_timesheet" data-field="x_timesheet_id" data-hidden="1" name="x_timesheet_id" id="x_timesheet_id" value="<?= HtmlEncode($Page->timesheet_id->CurrentValue) ?>">
</span>
<?php if (!$Page->IsModal) { ?>
