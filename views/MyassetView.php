...
loadjs.ready("head", function () {
    ...
    fmyassetview = currentForm = new ew.Form("fmyassetview", "view");
    loadjs.done("fmyassetview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="fmyassetview" id="fmyassetview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->asset_name->Visible) { // asset_name ?>
    <tr id="r_asset_name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_asset_name"><?= $Page->asset_name->caption() ?></span></td>
...
<?php if ($Page->year->Visible) { // year ?>
    <tr id="r_year">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_year"><?= $Page->year->caption() ?></span></td>
...
<?php if ($Page->serial_number->Visible) { // serial_number ?>
    <tr id="r_serial_number">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_serial_number"><?= $Page->serial_number->caption() ?></span></td>
...
<?php if ($Page->value->Visible) { // value ?>
    <tr id="r_value">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_value"><?= $Page->value->caption() ?></span></td>
...
<?php if ($Page->asset_received->Visible) { // asset_received ?>
    <tr id="r_asset_received">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_asset_received"><?= $Page->asset_received->caption() ?></span></td>
...
<?php if ($Page->asset_return->Visible) { // asset_return ?>
    <tr id="r_asset_return">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_asset_return"><?= $Page->asset_return->caption() ?></span></td>
...
<?php if ($Page->notes->Visible) { // notes ?>
    <tr id="r_notes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_notes"><?= $Page->notes->caption() ?></span></td>
...
<?php if ($Page->asset_picture->Visible) { // asset_picture ?>
    <tr id="r_asset_picture">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_myasset_asset_picture"><?= $Page->asset_picture->caption() ?></span></td>
