...
loadjs.ready("head", function () {
    ...
    fcustomeredit.lists.city_id = <?= $Page->city_id->toClientList($Page) ?>;
...
<?php } ?>
<form name="fcustomeredit" id="fcustomeredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="customer" data-field="x_customer_id" data-hidden="1" data-page="1" name="x_customer_id" id="x_customer_id" value="<?= HtmlEncode($Page->customer_id->CurrentValue) ?>">
</span>
<?php if (!$Page->IsModal) { ?>
