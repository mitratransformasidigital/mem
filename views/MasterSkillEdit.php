...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmaster_skilledit.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_skilledit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_skilledit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_skilledit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmaster_skilledit" id="fmaster_skilledit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="master_skill" data-field="x_skill_id" data-hidden="1" name="x_skill_id" id="x_skill_id" value="<?= HtmlEncode($Page->skill_id->CurrentValue) ?>">
</span>
