...
loadjs.ready("head", function () {
    ...
    factivityedit.addFields([
        ["activity_id", [fields.activity_id.required ? ew.Validators.required(fields.activity_id.caption) : null], fields.activity_id.isInvalid],
    ...
    factivityedit.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
...
<?php } ?>
<form name="factivityedit" id="factivityedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["factivityedit", "datetimepicker"], function() {
    ew.createDateTimePicker("factivityedit", "x_activity_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["factivityedit", "timepicker"], function() {
    ew.createTimePicker("factivityedit", "x_time_in", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":1});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["factivityedit", "timepicker"], function() {
    ew.createTimePicker("factivityedit", "x_time_out", {"timeFormat":"H" + ew.TIME_SEPARATOR + "i","step":1});
});
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="activity" data-field="x_activity_id" data-hidden="1" name="x_activity_id" id="x_activity_id" value="<?= HtmlEncode($Page->activity_id->CurrentValue) ?>">
</span>
<?php if (!$Page->IsModal) { ?>
