...
loadjs.ready("head", function () {
    ...
    // Validate form
    foffering_detailedit.validate = function () {
    ...
    // Form_CustomValidate
    foffering_detailedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    foffering_detailedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("foffering_detailedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="foffering_detailedit" id="foffering_detailedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el_offering_detail_detail_id">
<input type="hidden" data-table="offering_detail" data-field="x_detail_id" data-hidden="1" name="x_detail_id" id="x_detail_id" value="<?= HtmlEncode($Page->detail_id->CurrentValue) ?>">
</span>
<?php if (!$Page->IsModal) { ?>
