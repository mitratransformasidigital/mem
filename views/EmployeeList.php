...
<form name="femployeelistsrch" id="femployeelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="femployeelist" id="femployeelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->employee_name->Visible) { // employee_name ?>
        <th data-name="employee_name" class="<?= $Page->employee_name->headerCellClass() ?>"><div id="elh_employee_employee_name" class="employee_employee_name"><?= $Page->renderSort($Page->employee_name) ?></div></th>
<?php } ?>
<?php if ($Page->employee_username->Visible) { // employee_username ?>
        <th data-name="employee_username" class="<?= $Page->employee_username->headerCellClass() ?>"><div id="elh_employee_employee_username" class="employee_employee_username"><?= $Page->renderSort($Page->employee_username) ?></div></th>
<?php } ?>
<?php if ($Page->employee_password->Visible) { // employee_password ?>
        <th data-name="employee_password" class="<?= $Page->employee_password->headerCellClass() ?>"><div id="elh_employee_employee_password" class="employee_employee_password"><?= $Page->renderSort($Page->employee_password) ?></div></th>
<?php } ?>
<?php if ($Page->employee_email->Visible) { // employee_email ?>
        <th data-name="employee_email" class="<?= $Page->employee_email->headerCellClass() ?>"><div id="elh_employee_employee_email" class="employee_employee_email"><?= $Page->renderSort($Page->employee_email) ?></div></th>
<?php } ?>
<?php if ($Page->birth_date->Visible) { // birth_date ?>
        <th data-name="birth_date" class="<?= $Page->birth_date->headerCellClass() ?>"><div id="elh_employee_birth_date" class="employee_birth_date"><?= $Page->renderSort($Page->birth_date) ?></div></th>
<?php } ?>
<?php if ($Page->religion->Visible) { // religion ?>
        <th data-name="religion" class="<?= $Page->religion->headerCellClass() ?>"><div id="elh_employee_religion" class="employee_religion"><?= $Page->renderSort($Page->religion) ?></div></th>
<?php } ?>
<?php if ($Page->nik->Visible) { // nik ?>
        <th data-name="nik" class="<?= $Page->nik->headerCellClass() ?>"><div id="elh_employee_nik" class="employee_nik"><?= $Page->renderSort($Page->nik) ?></div></th>
<?php } ?>
<?php if ($Page->npwp->Visible) { // npwp ?>
        <th data-name="npwp" class="<?= $Page->npwp->headerCellClass() ?>"><div id="elh_employee_npwp" class="employee_npwp"><?= $Page->renderSort($Page->npwp) ?></div></th>
<?php } ?>
<?php if ($Page->address->Visible) { // address ?>
        <th data-name="address" class="<?= $Page->address->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_employee_address" class="employee_address"><?= $Page->renderSort($Page->address) ?></div></th>
<?php } ?>
<?php if ($Page->city_id->Visible) { // city_id ?>
        <th data-name="city_id" class="<?= $Page->city_id->headerCellClass() ?>"><div id="elh_employee_city_id" class="employee_city_id"><?= $Page->renderSort($Page->city_id) ?></div></th>
<?php } ?>
...
<?php if ($Page->bank_number->Visible) { // bank_number ?>
        <th data-name="bank_number" class="<?= $Page->bank_number->headerCellClass() ?>"><div id="elh_employee_bank_number" class="employee_bank_number"><?= $Page->renderSort($Page->bank_number) ?></div></th>
<?php } ?>
<?php if ($Page->bank_name->Visible) { // bank_name ?>
        <th data-name="bank_name" class="<?= $Page->bank_name->headerCellClass() ?>"><div id="elh_employee_bank_name" class="employee_bank_name"><?= $Page->renderSort($Page->bank_name) ?></div></th>
<?php } ?>
<?php if ($Page->scan_ktp->Visible) { // scan_ktp ?>
        <th data-name="scan_ktp" class="<?= $Page->scan_ktp->headerCellClass() ?>"><div id="elh_employee_scan_ktp" class="employee_scan_ktp"><?= $Page->renderSort($Page->scan_ktp) ?></div></th>
<?php } ?>
<?php if ($Page->scan_npwp->Visible) { // scan_npwp ?>
        <th data-name="scan_npwp" class="<?= $Page->scan_npwp->headerCellClass() ?>"><div id="elh_employee_scan_npwp" class="employee_scan_npwp"><?= $Page->renderSort($Page->scan_npwp) ?></div></th>
<?php } ?>
<?php if ($Page->curiculum_vitae->Visible) { // curiculum_vitae ?>
        <th data-name="curiculum_vitae" class="<?= $Page->curiculum_vitae->headerCellClass() ?>"><div id="elh_employee_curiculum_vitae" class="employee_curiculum_vitae"><?= $Page->renderSort($Page->curiculum_vitae) ?></div></th>
<?php } ?>
<?php if ($Page->position_id->Visible) { // position_id ?>
        <th data-name="position_id" class="<?= $Page->position_id->headerCellClass() ?>"><div id="elh_employee_position_id" class="employee_position_id"><?= $Page->renderSort($Page->position_id) ?></div></th>
<?php } ?>
<?php if ($Page->status_id->Visible) { // status_id ?>
        <th data-name="status_id" class="<?= $Page->status_id->headerCellClass() ?>"><div id="elh_employee_status_id" class="employee_status_id"><?= $Page->renderSort($Page->status_id) ?></div></th>
<?php } ?>
<?php if ($Page->skill_id->Visible) { // skill_id ?>
        <th data-name="skill_id" class="<?= $Page->skill_id->headerCellClass() ?>"><div id="elh_employee_skill_id" class="employee_skill_id"><?= $Page->renderSort($Page->skill_id) ?></div></th>
<?php } ?>
<?php if ($Page->office_id->Visible) { // office_id ?>
        <th data-name="office_id" class="<?= $Page->office_id->headerCellClass() ?>"><div id="elh_employee_office_id" class="employee_office_id"><?= $Page->renderSort($Page->office_id) ?></div></th>
<?php } ?>
<?php if ($Page->hire_date->Visible) { // hire_date ?>
        <th data-name="hire_date" class="<?= $Page->hire_date->headerCellClass() ?>"><div id="elh_employee_hire_date" class="employee_hire_date"><?= $Page->renderSort($Page->hire_date) ?></div></th>
<?php } ?>
...
<?php if ($Page->user_level->Visible) { // user_level ?>
        <th data-name="user_level" class="<?= $Page->user_level->headerCellClass() ?>"><div id="elh_employee_user_level" class="employee_user_level"><?= $Page->renderSort($Page->user_level) ?></div></th>
<?php } ?>
<?php if ($Page->technical_skill->Visible) { // technical_skill ?>
        <th data-name="technical_skill" class="<?= $Page->technical_skill->headerCellClass() ?>"><div id="elh_employee_technical_skill" class="employee_technical_skill"><?= $Page->renderSort($Page->technical_skill) ?></div></th>
<?php } ?>
<?php if ($Page->about_me->Visible) { // about_me ?>
        <th data-name="about_me" class="<?= $Page->about_me->headerCellClass() ?>"><div id="elh_employee_about_me" class="employee_about_me"><?= $Page->renderSort($Page->about_me) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_employee_employee_name">
...
<span id="el<?= $Page->RowCount ?>_employee_employee_username">
...
<span id="el<?= $Page->RowCount ?>_employee_employee_password">
...
<span id="el<?= $Page->RowCount ?>_employee_employee_email">
...
<span id="el<?= $Page->RowCount ?>_employee_birth_date">
...
<span id="el<?= $Page->RowCount ?>_employee_religion">
...
<span id="el<?= $Page->RowCount ?>_employee_nik">
...
<span id="el<?= $Page->RowCount ?>_employee_npwp">
...
<span id="el<?= $Page->RowCount ?>_employee_address">
...
<span id="el<?= $Page->RowCount ?>_employee_city_id">
...
<span id="el<?= $Page->RowCount ?>_employee_bank_number">
...
<span id="el<?= $Page->RowCount ?>_employee_bank_name">
...
<span id="el<?= $Page->RowCount ?>_employee_scan_ktp">
...
<span id="el<?= $Page->RowCount ?>_employee_scan_npwp">
...
<span id="el<?= $Page->RowCount ?>_employee_curiculum_vitae">
...
<span id="el<?= $Page->RowCount ?>_employee_position_id">
...
<span id="el<?= $Page->RowCount ?>_employee_status_id">
...
<span id="el<?= $Page->RowCount ?>_employee_skill_id">
...
<span id="el<?= $Page->RowCount ?>_employee_office_id">
...
<span id="el<?= $Page->RowCount ?>_employee_hire_date">
...
<span id="el<?= $Page->RowCount ?>_employee_user_level">
...
<span id="el<?= $Page->RowCount ?>_employee_technical_skill">
...
<span id="el<?= $Page->RowCount ?>_employee_about_me">
