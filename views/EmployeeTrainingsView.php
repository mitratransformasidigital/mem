...
// Page object
$EmployeeTrainingsView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var femployee_trainingsview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    femployee_trainingsview = currentForm = new ew.Form("femployee_trainingsview", "view");
    loadjs.done("femployee_trainingsview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="femployee_trainingsview" id="femployee_trainingsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->employee_username->Visible) { // employee_username ?>
    <tr id="r_employee_username">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_employee_username"><?= $Page->employee_username->caption() ?></span></td>
...
<?php if ($Page->training_name->Visible) { // training_name ?>
    <tr id="r_training_name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_training_name"><?= $Page->training_name->caption() ?></span></td>
...
<?php if ($Page->training_start->Visible) { // training_start ?>
    <tr id="r_training_start">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_training_start"><?= $Page->training_start->caption() ?></span></td>
...
<?php if ($Page->training_end->Visible) { // training_end ?>
    <tr id="r_training_end">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_training_end"><?= $Page->training_end->caption() ?></span></td>
...
<?php if ($Page->training_company->Visible) { // training_company ?>
    <tr id="r_training_company">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_training_company"><?= $Page->training_company->caption() ?></span></td>
...
<?php if ($Page->certificate_start->Visible) { // certificate_start ?>
    <tr id="r_certificate_start">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_certificate_start"><?= $Page->certificate_start->caption() ?></span></td>
...
<?php if ($Page->certificate_end->Visible) { // certificate_end ?>
    <tr id="r_certificate_end">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_certificate_end"><?= $Page->certificate_end->caption() ?></span></td>
...
<?php if ($Page->notes->Visible) { // notes ?>
    <tr id="r_notes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_notes"><?= $Page->notes->caption() ?></span></td>
...
<?php if ($Page->training_document->Visible) { // training_document ?>
    <tr id="r_training_document">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_trainings_training_document"><?= $Page->training_document->caption() ?></span></td>
