...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmaster_provinceedit.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_provinceedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_provinceedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_provinceedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmaster_provinceedit" id="fmaster_provinceedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("master_city", explode(",", $Page->getCurrentDetailTable())) && $master_city->DetailEdit) {
?>
