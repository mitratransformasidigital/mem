...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmaster_statusedit.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_statusedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_statusedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_statusedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmaster_statusedit" id="fmaster_statusedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el_master_status_status_id">
<input type="hidden" data-table="master_status" data-field="x_status_id" data-hidden="1" name="x_status_id" id="x_status_id" value="<?= HtmlEncode($Page->status_id->CurrentValue) ?>">
</span>
