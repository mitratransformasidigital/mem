...
var femployee_timesheetsearch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    <?php if ($Page->IsModal) { ?>
    femployee_timesheetsearch = currentAdvancedSearchForm = new ew.Form("femployee_timesheetsearch", "search");
    <?php } else { ?>
    femployee_timesheetsearch = currentForm = new ew.Form("femployee_timesheetsearch", "search");
    <?php } ?>
    currentPageID = ew.PAGE_ID = "search";

    // Add fields
    var fields = ew.vars.tables.employee_timesheet.fields;
    femployee_timesheetsearch.addFields([
    ...
    // Set invalid fields
    $(function() {
        femployee_timesheetsearch.setInvalid();
    });

    // Validate form
    femployee_timesheetsearch.validate = function () {
    ...
    // Form_CustomValidate
    femployee_timesheetsearch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_timesheetsearch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_timesheetsearch.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    femployee_timesheetsearch.lists.year = <?= $Page->year->toClientList($Page) ?>;
    femployee_timesheetsearch.lists.month = <?= $Page->month->toClientList($Page) ?>;
    femployee_timesheetsearch.lists.approved = <?= $Page->approved->toClientList($Page) ?>;
    loadjs.done("femployee_timesheetsearch");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_timesheetsearch" id="femployee_timesheetsearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->employee_username->Visible) { // employee_username ?>
    <div id="r_employee_username" class="form-group row">
        <label for="x_employee_username" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_employee_username"><?= $Page->employee_username->caption() ?></span>
...
<input type="hidden" name="z_employee_username" id="z_employee_username" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->employee_username->cellAttributes() ?>>
            <span id="el_employee_timesheet_employee_username" class="ew-search-field">
    <select
...
<?php if ($Page->days->Visible) { // days ?>
    <div id="r_days" class="form-group row">
        <label for="x_days" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_days"><?= $Page->days->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->days->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_days" class="ew-search-field">
<input type="<?= $Page->days->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_days" name="x_days" id="x_days" size="30" placeholder="<?= HtmlEncode($Page->days->getPlaceHolder()) ?>" value="<?= $Page->days->EditValue ?>"<?= $Page->days->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->days->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_days" class="ew-search-field2 d-none">
<input type="<?= $Page->days->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_days" name="y_days" id="y_days" size="30" placeholder="<?= HtmlEncode($Page->days->getPlaceHolder()) ?>" value="<?= $Page->days->EditValue2 ?>"<?= $Page->days->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->days->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->sick->Visible) { // sick ?>
    <div id="r_sick" class="form-group row">
        <label for="x_sick" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_sick"><?= $Page->sick->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->sick->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_sick" class="ew-search-field">
<input type="<?= $Page->sick->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_sick" name="x_sick" id="x_sick" size="30" placeholder="<?= HtmlEncode($Page->sick->getPlaceHolder()) ?>" value="<?= $Page->sick->EditValue ?>"<?= $Page->sick->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->sick->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_sick" class="ew-search-field2 d-none">
<input type="<?= $Page->sick->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_sick" name="y_sick" id="y_sick" size="30" placeholder="<?= HtmlEncode($Page->sick->getPlaceHolder()) ?>" value="<?= $Page->sick->EditValue2 ?>"<?= $Page->sick->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->sick->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->leave->Visible) { // leave ?>
    <div id="r_leave" class="form-group row">
        <label for="x_leave" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_leave"><?= $Page->leave->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->leave->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_leave" class="ew-search-field">
<input type="<?= $Page->leave->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_leave" name="x_leave" id="x_leave" size="30" placeholder="<?= HtmlEncode($Page->leave->getPlaceHolder()) ?>" value="<?= $Page->leave->EditValue ?>"<?= $Page->leave->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->leave->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_leave" class="ew-search-field2 d-none">
<input type="<?= $Page->leave->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_leave" name="y_leave" id="y_leave" size="30" placeholder="<?= HtmlEncode($Page->leave->getPlaceHolder()) ?>" value="<?= $Page->leave->EditValue2 ?>"<?= $Page->leave->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->leave->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->permit->Visible) { // permit ?>
    <div id="r_permit" class="form-group row">
        <label for="x_permit" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_permit"><?= $Page->permit->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->permit->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_permit" class="ew-search-field">
<input type="<?= $Page->permit->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_permit" name="x_permit" id="x_permit" size="30" placeholder="<?= HtmlEncode($Page->permit->getPlaceHolder()) ?>" value="<?= $Page->permit->EditValue ?>"<?= $Page->permit->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->permit->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_permit" class="ew-search-field2 d-none">
<input type="<?= $Page->permit->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_permit" name="y_permit" id="y_permit" size="30" placeholder="<?= HtmlEncode($Page->permit->getPlaceHolder()) ?>" value="<?= $Page->permit->EditValue2 ?>"<?= $Page->permit->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->permit->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->absence->Visible) { // absence ?>
    <div id="r_absence" class="form-group row">
        <label for="x_absence" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_absence"><?= $Page->absence->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->absence->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_absence" class="ew-search-field">
<input type="<?= $Page->absence->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_absence" name="x_absence" id="x_absence" size="30" placeholder="<?= HtmlEncode($Page->absence->getPlaceHolder()) ?>" value="<?= $Page->absence->EditValue ?>"<?= $Page->absence->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->absence->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_absence" class="ew-search-field2 d-none">
<input type="<?= $Page->absence->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_absence" name="y_absence" id="y_absence" size="30" placeholder="<?= HtmlEncode($Page->absence->getPlaceHolder()) ?>" value="<?= $Page->absence->EditValue2 ?>"<?= $Page->absence->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->absence->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->employee_notes->Visible) { // employee_notes ?>
    <div id="r_employee_notes" class="form-group row">
        <label for="x_employee_notes" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_employee_notes"><?= $Page->employee_notes->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->employee_notes->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_employee_notes" class="ew-search-field">
<input type="<?= $Page->employee_notes->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_employee_notes" name="x_employee_notes" id="x_employee_notes" size="35" placeholder="<?= HtmlEncode($Page->employee_notes->getPlaceHolder()) ?>" value="<?= $Page->employee_notes->EditValue ?>"<?= $Page->employee_notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->employee_notes->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_employee_notes" class="ew-search-field2 d-none">
<input type="<?= $Page->employee_notes->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_employee_notes" name="y_employee_notes" id="y_employee_notes" size="35" placeholder="<?= HtmlEncode($Page->employee_notes->getPlaceHolder()) ?>" value="<?= $Page->employee_notes->EditValue2 ?>"<?= $Page->employee_notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->employee_notes->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->company_notes->Visible) { // company_notes ?>
    <div id="r_company_notes" class="form-group row">
        <label for="x_company_notes" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_company_notes"><?= $Page->company_notes->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->company_notes->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_company_notes" class="ew-search-field">
<input type="<?= $Page->company_notes->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_company_notes" name="x_company_notes" id="x_company_notes" size="35" placeholder="<?= HtmlEncode($Page->company_notes->getPlaceHolder()) ?>" value="<?= $Page->company_notes->EditValue ?>"<?= $Page->company_notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->company_notes->getErrorMessage(false) ?></div>
</span>
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_company_notes" class="ew-search-field2 d-none">
<input type="<?= $Page->company_notes->getInputTextType() ?>" data-table="employee_timesheet" data-field="x_company_notes" name="y_company_notes" id="y_company_notes" size="35" placeholder="<?= HtmlEncode($Page->company_notes->getPlaceHolder()) ?>" value="<?= $Page->company_notes->EditValue2 ?>"<?= $Page->company_notes->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->company_notes->getErrorMessage(false) ?></div>
</span>
        </div></div>
    </div>
...
<?php if ($Page->approved->Visible) { // approved ?>
    <div id="r_approved" class="form-group row">
        <label for="x_approved" class="<?= $Page->LeftColumnClass ?>"><span id="elh_employee_timesheet_approved"><?= $Page->approved->caption() ?></span>
        </label>
...
<option value="BETWEEN"<?= $Page->approved->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
            ...
            <span id="el_employee_timesheet_approved" class="ew-search-field">
    <select
        id="x_approved"
        name="x_approved"
...
loadjs.ready("head", function() {
    ...
    ew.createSelect(options);
            ...
            <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
            <span id="el2_employee_timesheet_approved" class="ew-search-field2 d-none">
    <select
        id="y_approved"
        name="y_approved"
        class="form-control ew-select<?= $Page->approved->isInvalidClass() ?>"
        data-select2-id="employee_timesheet_y_approved"
        data-table="employee_timesheet"
        data-field="x_approved"
        data-value-separator="<?= $Page->approved->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->approved->getPlaceHolder()) ?>"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='employee_timesheet_y_approved']"),
        options = { name: "y_approved", selectId: "employee_timesheet_y_approved", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.employee_timesheet.fields.approved.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.employee_timesheet.fields.approved.selectOptions);
    ew.createSelect(options);
