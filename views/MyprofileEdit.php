...
loadjs.ready("head", function () {
    ...
    fmyprofileedit = currentForm = new ew.Form("fmyprofileedit", "edit");

    // Add fields
    var fields = ew.vars.tables.myprofile.fields;
    fmyprofileedit.addFields([
    ...
    // Validate form
    fmyprofileedit.validate = function () {
    ...
    // Form_CustomValidate
    fmyprofileedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmyprofileedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Multi-Page
    fmyprofileedit.multiPage = new ew.MultiPage("fmyprofileedit");

    // Dynamic selection lists
    fmyprofileedit.lists.city_id = <?= $Page->city_id->toClientList($Page) ?>;
    fmyprofileedit.lists.position_id = <?= $Page->position_id->toClientList($Page) ?>;
    fmyprofileedit.lists.religion = <?= $Page->religion->toClientList($Page) ?>;
    fmyprofileedit.lists.status_id = <?= $Page->status_id->toClientList($Page) ?>;
    fmyprofileedit.lists.skill_id = <?= $Page->skill_id->toClientList($Page) ?>;
    fmyprofileedit.lists.office_id = <?= $Page->office_id->toClientList($Page) ?>;
    loadjs.done("fmyprofileedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmyprofileedit" id="fmyprofileedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="myprofile" data-field="x_employee_username" data-hidden="1" data-page="1" name="o_employee_username" id="o_employee_username" value="<?= HtmlEncode($Page->employee_username->OldValue ?? $Page->employee_username->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fmyprofileedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmyprofileedit", "x_birth_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmyprofileedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmyprofileedit", "x_hire_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmyprofileedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmyprofileedit", "x_termination_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<span id="el_myprofile_user_level">
<input type="hidden" data-table="myprofile" data-field="x_user_level" data-hidden="1" data-page="3" name="x_user_level" id="x_user_level" value="<?= HtmlEncode($Page->user_level->CurrentValue) ?>">
</span>
