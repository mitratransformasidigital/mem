...
<form name="fcustomerlistsrch" id="fcustomerlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<?php } ?>
<form name="fcustomerlist" id="fcustomerlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->customer_name->Visible) { // customer_name ?>
        <th data-name="customer_name" class="<?= $Page->customer_name->headerCellClass() ?>"><div id="elh_customer_customer_name" class="customer_customer_name"><?= $Page->renderSort($Page->customer_name) ?></div></th>
<?php } ?>
<?php if ($Page->address->Visible) { // address ?>
        <th data-name="address" class="<?= $Page->address->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_customer_address" class="customer_address"><?= $Page->renderSort($Page->address) ?></div></th>
<?php } ?>
<?php if ($Page->city_id->Visible) { // city_id ?>
        <th data-name="city_id" class="<?= $Page->city_id->headerCellClass() ?>"><div id="elh_customer_city_id" class="customer_city_id"><?= $Page->renderSort($Page->city_id) ?></div></th>
<?php } ?>
<?php if ($Page->phone_number->Visible) { // phone_number ?>
        <th data-name="phone_number" class="<?= $Page->phone_number->headerCellClass() ?>"><div id="elh_customer_phone_number" class="customer_phone_number"><?= $Page->renderSort($Page->phone_number) ?></div></th>
<?php } ?>
<?php if ($Page->contact->Visible) { // contact ?>
        <th data-name="contact" class="<?= $Page->contact->headerCellClass() ?>"><div id="elh_customer_contact" class="customer_contact"><?= $Page->renderSort($Page->contact) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_customer_customer_name">
...
<span id="el<?= $Page->RowCount ?>_customer_address">
...
<span id="el<?= $Page->RowCount ?>_customer_city_id">
...
<span id="el<?= $Page->RowCount ?>_customer_phone_number">
...
<span id="el<?= $Page->RowCount ?>_customer_contact">
