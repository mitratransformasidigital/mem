...
loadjs.ready("head", function () {
    ...
    fmycontractview = currentForm = new ew.Form("fmycontractview", "view");
    loadjs.done("fmycontractview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="fmycontractview" id="fmycontractview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->salary->Visible) { // salary ?>
    <tr id="r_salary">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_salary"><?= $Page->salary->caption() ?></span></td>
...
<?php if ($Page->bonus->Visible) { // bonus ?>
    <tr id="r_bonus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_bonus"><?= $Page->bonus->caption() ?></span></td>
...
<?php if ($Page->thr->Visible) { // thr ?>
    <tr id="r_thr">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_thr"><?= $Page->thr->caption() ?></span></td>
...
<?php if ($Page->contract_start->Visible) { // contract_start ?>
    <tr id="r_contract_start">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_contract_start"><?= $Page->contract_start->caption() ?></span></td>
...
<?php if ($Page->contract_end->Visible) { // contract_end ?>
    <tr id="r_contract_end">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_contract_end"><?= $Page->contract_end->caption() ?></span></td>
...
<?php if ($Page->office_id->Visible) { // office_id ?>
    <tr id="r_office_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_office_id"><?= $Page->office_id->caption() ?></span></td>
...
<?php if ($Page->notes->Visible) { // notes ?>
    <tr id="r_notes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_notes"><?= $Page->notes->caption() ?></span></td>
...
<?php if ($Page->contract_document->Visible) { // contract_document ?>
    <tr id="r_contract_document">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mycontract_contract_document"><?= $Page->contract_document->caption() ?></span></td>
