...
$sideMenu->addMenuItem(217, "mi_v_offering_list", $MenuLanguage->MenuPhrase("217", "MenuText"), $MenuRelativePath . "vofferinglistlist", -1, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}v_offering_list'), false, false, "", "", false);
$sideMenu->addMenuItem(213, "mi_master_work_date", $MenuLanguage->MenuPhrase("213", "MenuText"), $MenuRelativePath . "masterworkdatelist", -1, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}master_work_date'), false, false, "", "", false);
...
$sideMenu->addMenuItem(95, "mci_My_Activity", $MenuLanguage->MenuPhrase("95", "MenuText"), "", -1, "", IsLoggedIn(), false, true, "fa-tasks", "", false);
...
$sideMenu->addMenuItem(133, "mci_HR", $MenuLanguage->MenuPhrase("133", "MenuText"), "", 46, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(47, "mi_permit", $MenuLanguage->MenuPhrase("47", "MenuText"), $MenuRelativePath . "permitlist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}permit'), false, false, "", "", false);
$sideMenu->addMenuItem(31, "mi_activity", $MenuLanguage->MenuPhrase("31", "MenuText"), $MenuRelativePath . "activitylist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}activity'), false, false, "", "", false);
$sideMenu->addMenuItem(72, "mi_employee_contract", $MenuLanguage->MenuPhrase("72", "MenuText"), $MenuRelativePath . "employeecontractlist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}employee_contract'), false, false, "", "", false);
$sideMenu->addMenuItem(73, "mi_employee_asset", $MenuLanguage->MenuPhrase("73", "MenuText"), $MenuRelativePath . "employeeassetlist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}employee_asset'), false, false, "", "", false);
$sideMenu->addMenuItem(74, "mi_employee_trainings", $MenuLanguage->MenuPhrase("74", "MenuText"), $MenuRelativePath . "employeetrainingslist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}employee_trainings'), false, false, "", "", false);
$sideMenu->addMenuItem(14, "mi_employee_timesheet", $MenuLanguage->MenuPhrase("14", "MenuText"), $MenuRelativePath . "employeetimesheetlist?cmd=resetall", 133, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}employee_timesheet'), false, false, "", "", false);
$sideMenu->addMenuItem(169, "mci_Invoice", $MenuLanguage->MenuPhrase("169", "MenuText"), "", 46, "", IsLoggedIn(), false, true, "", "", false);
$sideMenu->addMenuItem(134, "mi_employee_quotation", $MenuLanguage->MenuPhrase("134", "MenuText"), $MenuRelativePath . "employeequotationlist", 169, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}employee_quotation'), false, false, "", "", false);
$sideMenu->addMenuItem(215, "mi_offering", $MenuLanguage->MenuPhrase("215", "MenuText"), $MenuRelativePath . "offeringlist", 169, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}offering'), false, false, "", "", false);
...
$sideMenu->addMenuItem(102, "mi_customer", $MenuLanguage->MenuPhrase("102", "MenuText"), $MenuRelativePath . "customerlist?cmd=resetall", 2, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}customer'), false, false, "", "", false);
...
$sideMenu->addMenuItem(210, "mci_Report", $MenuLanguage->MenuPhrase("210", "MenuText"), "", -1, "", IsLoggedIn(), false, true, "fa-print", "", false);
$sideMenu->addMenuItem(211, "mi_quotation_print", $MenuLanguage->MenuPhrase("211", "MenuText"), $MenuRelativePath . "quotationprint", 210, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}quotation_print'), false, false, "", "", false);
$sideMenu->addMenuItem(218, "mi_offering_print", $MenuLanguage->MenuPhrase("218", "MenuText"), $MenuRelativePath . "offeringprint", 210, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}offering_print'), false, false, "", "", false);
$sideMenu->addMenuItem(212, "mi_v_timesheet_list", $MenuLanguage->MenuPhrase("212", "MenuText"), $MenuRelativePath . "vtimesheetlistlist", 210, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}v_timesheet_list'), false, false, "", "", false);
...
$sideMenu->addMenuItem(173, "mi_setting", $MenuLanguage->MenuPhrase("173", "MenuText"), $MenuRelativePath . "settinglist", -1, "", AllowListMenu('{83F75968-657B-46AA-B0FF-ABCCF02B6D71}setting'), false, false, "fa-cog ", "", false);
