...
loadjs.ready("head", function () {
    ...
    femployeeadd.lists.religion = <?= $Page->religion->toClientList($Page) ?>;
    femployeeadd.lists.city_id = <?= $Page->city_id->toClientList($Page) ?>;
    femployeeadd.lists.position_id = <?= $Page->position_id->toClientList($Page) ?>;
    femployeeadd.lists.status_id = <?= $Page->status_id->toClientList($Page) ?>;
    femployeeadd.lists.skill_id = <?= $Page->skill_id->toClientList($Page) ?>;
    femployeeadd.lists.office_id = <?= $Page->office_id->toClientList($Page) ?>;
    femployeeadd.lists.user_level = <?= $Page->user_level->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployeeadd" id="femployeeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["femployeeadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeadd", "x_birth_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployeeadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeadd", "x_hire_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployeeadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployeeadd", "x_termination_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
});
</script>
<?php } ?>
</span>
...
?>
<?php
    if (in_array("activity", explode(",", $Page->getCurrentDetailTable())) && $activity->DetailAdd) {
...
?>
<?php
    if (in_array("permit", explode(",", $Page->getCurrentDetailTable())) && $permit->DetailAdd) {
...
?>
<?php
    if (in_array("employee_contract", explode(",", $Page->getCurrentDetailTable())) && $employee_contract->DetailAdd) {
...
?>
<?php
    if (in_array("employee_asset", explode(",", $Page->getCurrentDetailTable())) && $employee_asset->DetailAdd) {
...
?>
<?php
    if (in_array("employee_timesheet", explode(",", $Page->getCurrentDetailTable())) && $employee_timesheet->DetailAdd) {
...
?>
<?php
    if (in_array("employee_trainings", explode(",", $Page->getCurrentDetailTable())) && $employee_trainings->DetailAdd) {
