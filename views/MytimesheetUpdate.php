...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmytimesheetupdate.validate = function () {
    ...
    // Form_CustomValidate
    fmytimesheetupdate.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmytimesheetupdate.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fmytimesheetupdate.lists.year = <?= $Page->year->toClientList($Page) ?>;
    fmytimesheetupdate.lists.month = <?= $Page->month->toClientList($Page) ?>;
    fmytimesheetupdate.lists.approved = <?= $Page->approved->toClientList($Page) ?>;
    loadjs.done("fmytimesheetupdate");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmytimesheetupdate" id="fmytimesheetupdate" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php } ?>
<div id="tbl_mytimesheetupdate" class="ew-update-div"><!-- page -->
