...
loadjs.ready("head", function () {
    ...
    fsettingedit = currentForm = new ew.Form("fsettingedit", "edit");

    // Add fields
    var fields = ew.vars.tables.setting.fields;
    fsettingedit.addFields([
        ["setting_id", [fields.setting_id.required ? ew.Validators.required(fields.setting_id.caption) : null], fields.setting_id.isInvalid],
    ...
    fsettingedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
<?php } ?>
<form name="fsettingedit" id="fsettingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<span id="el_setting_setting_id">
<input type="hidden" data-table="setting" data-field="x_setting_id" data-hidden="1" data-page="1" name="x_setting_id" id="x_setting_id" value="<?= HtmlEncode($Page->setting_id->CurrentValue) ?>">
</span>
<?php if (!$Page->IsModal) { ?>
