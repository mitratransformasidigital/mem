...
loadjs.ready("head", function () {
    ...
    // Validate form
    fmaster_work_dateadd.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_work_dateadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_work_dateadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_work_dateadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmaster_work_dateadd" id="fmaster_work_dateadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmaster_work_dateadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmaster_work_dateadd", "x_work_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
