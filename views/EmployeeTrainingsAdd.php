...
var femployee_trainingsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_trainingsadd = currentForm = new ew.Form("femployee_trainingsadd", "add");

    // Add fields
    var fields = ew.vars.tables.employee_trainings.fields;
    femployee_trainingsadd.addFields([
    ...
    // Validate form
    femployee_trainingsadd.validate = function () {
    ...
    // Form_CustomValidate
    femployee_trainingsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_trainingsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_trainingsadd.lists.employee_username = <?= $Page->employee_username->toClientList($Page) ?>;
    loadjs.done("femployee_trainingsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_trainingsadd" id="femployee_trainingsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_trainingsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_trainingsadd", "x_training_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_trainingsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_trainingsadd", "x_training_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_trainingsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_trainingsadd", "x_certificate_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_trainingsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_trainingsadd", "x_certificate_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
