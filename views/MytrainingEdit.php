...
loadjs.ready("head", function () {
    ...
    fmytrainingedit = currentForm = new ew.Form("fmytrainingedit", "edit");

    // Add fields
    var fields = ew.vars.tables.mytraining.fields;
    fmytrainingedit.addFields([
    ...
    // Validate form
    fmytrainingedit.validate = function () {
    ...
    // Form_CustomValidate
    fmytrainingedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmytrainingedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmytrainingedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fmytrainingedit" id="fmytrainingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmytrainingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmytrainingedit", "x_training_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmytrainingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmytrainingedit", "x_training_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmytrainingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmytrainingedit", "x_certificate_start", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmytrainingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmytrainingedit", "x_certificate_end", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
